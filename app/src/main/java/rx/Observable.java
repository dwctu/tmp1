...
public class Observable<T> {
    ...
    public final <R> Observable<R> concatMapDelayError(Func1<? super T, ? extends Observable<? extends R>> func1) {
        return this instanceof ScalarSynchronousObservable ? ((ScalarSynchronousObservable) this).scalarFlatMap(func1) : unsafeCreate(new OnSubscribeConcatMap(this, func1, 2, 2));
    }
    ...
    public final Observable<T> takeLast(int i) {
        return i == 0 ? ignoreElements() : i == 1 ? unsafeCreate(new OnSubscribeTakeLastOne(this)) : (Observable<T>) lift(new OperatorTakeLast(i));
    }
