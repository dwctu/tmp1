...
public final class SpotifyTrack {
    ...
    private static AudioTrackInstantiation mAudioTrackInstantiation;
    ...
    public static int getAudioSessionId() {
        return mAudioTrackInstantiation.getAudioSessionId();
    }
    ...
    public static SpotifyPlayer getPlayer(Config config, Object obj, SpotifyPlayer.InitializationObserver initializationObserver) {
        ...
        AudioTrackInstantiation audioTrackInstantiation = new AudioTrackInstantiation();
        mAudioTrackInstantiation = audioTrackInstantiation;
        builder.setAudioController(audioTrackInstantiation);
        return getPlayer(builder, obj, initializationObserver);
    }
