...
public class LocalNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent activity = PendingIntent.getActivity(context, intExtra, intent2, AudioRoutingController.DEVICE_OUT_USB_HEADSET);
        ...
        if (i >= 26 && notificationManager != null && notificationManager.getNotificationChannel(NOTIFICATION_CHANNEL_ID) == null) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, NOTICATION_CHANNEL_NAME, 3);
