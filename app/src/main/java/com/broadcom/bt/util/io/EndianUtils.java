...
public class EndianUtils {
    ...
    public static long readSwappedLong(byte[] bArr, int i) {
        return ((((((bArr[i + 4] & 255) << 0) + ((bArr[i + 5] & 255) << 8)) + ((bArr[i + 6] & 255) << 16)) + ((bArr[i + 7] & 255) << 24)) << 32) + ((((bArr[i + 0] & 255) << 0) + ((bArr[i + 1] & 255) << 8) + ((bArr[i + 2] & 255) << 16) + ((bArr[i + 3] & 255) << 24)) & UnsignedInts.INT_MASK);
    }
    ...
    public static long readSwappedUnsignedInteger(byte[] bArr, int i) {
        return ((bArr[i + 3] & 255) << 24) + ((((bArr[i + 0] & 255) << 0) + ((bArr[i + 1] & 255) << 8) + ((bArr[i + 2] & 255) << 16)) & UnsignedInts.INT_MASK);
    }
    ...
    public static long readSwappedUnsignedInteger(InputStream inputStream) throws IOException {
        return ((read(inputStream) & 255) << 24) + ((((read(inputStream) & 255) << 0) + ((read(inputStream) & 255) << 8) + ((read(inputStream) & 255) << 16)) & UnsignedInts.INT_MASK);
    }
