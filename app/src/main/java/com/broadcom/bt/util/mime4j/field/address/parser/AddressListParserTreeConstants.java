...
public interface AddressListParserTreeConstants {
    ...
    public static final String[] jjtNodeName = {"void", "address_list", MultipleAddresses.Address.ELEMENT, "mailbox", "name_addr", "group_body", "angle_addr", "route", "phrase", "addr_spec", "local_part", "domain"};
}
