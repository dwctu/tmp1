...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _createInstance(Context context, MethodVisitor methodVisitor) {
        ...
        if (Modifier.isPublic(constructor.getModifiers())) {
            ...
            methodVisitor.visitVarInsn(58, context.var(DefaultSettingsSpiCall.INSTANCE_PARAM));
            return;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:134:0x0e1d  */
    /*
    ...
    */
    ...
    private void _deserialzeArrayMapping(ClassWriter classWriter, Context context) {
        ...
        methodWriter.visitVarInsn(25, context.var(DefaultSettingsSpiCall.INSTANCE_PARAM));
    ...
    private void _loadAndSet(Context context, MethodVisitor methodVisitor, FieldInfo fieldInfo) {
        ...
        java.lang.reflect.Type type = fieldInfo.fieldType;
        if (cls == Boolean.TYPE) {
            methodVisitor.visitVarInsn(25, context.var(DefaultSettingsSpiCall.INSTANCE_PARAM));
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig parserConfig, JavaBeanInfo javaBeanInfo) throws Exception {
        ...
        String str2 = "FastjsonASMDeserializer_" + this.seed.incrementAndGet() + Config.IN_FIELD_SEPARATOR + cls.getSimpleName();
