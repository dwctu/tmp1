...
public class JavaxPersistence {
    public static DatabaseFieldConfig createFieldConfig(DatabaseType databaseType, Field field) throws IllegalAccessException, SQLException, IllegalArgumentException, InvocationTargetException {
        ...
        if (annotation4 != null) {
            try {
                Boolean bool3 = (Boolean) annotation4.getClass().getMethod(Session.Feature.OPTIONAL_ELEMENT, new Class[0]).invoke(annotation4, new Object[0]);
                if (bool3 == null) {
            ...
            if (Collection.class.isAssignableFrom(field.getType()) || ForeignCollection.class.isAssignableFrom(field.getType())) {
                ...
                if (annotation11 != null) {
                    try {
                        ...
                        Object objInvoke = annotation11.getClass().getMethod(RemoteConfigComponent.FETCH_FILE_NAME, new Class[0]).invoke(annotation11, new Object[0]);
        ...
        if (annotation2 != null) {
            try {
                Object objInvoke2 = annotation2.getClass().getMethod("value", new Class[0]).invoke(annotation2, new Object[0]);
