...
public abstract class BaseDaoImpl<T, ID> implements Dao<T, ID> {
    ...
    public Dao.CreateOrUpdateStatus createOrUpdate(T t) throws SQLException {
        ...
        return (idExtractId == null || !idExists(idExtractId)) ? new Dao.CreateOrUpdateStatus(true, false, create(t)) : new Dao.CreateOrUpdateStatus(false, true, update((BaseDaoImpl<T, ID>) t));
    }
