...
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    private static <N> GraphConnections<N, GraphConstants.Presence> connectionsOf(Graph<N> graph, N n) {
        ...
        return graph.isDirected() ? DirectedGraphConnections.ofImmutable(graph.predecessors((Graph<N>) n), Maps.asMap(graph.successors((Graph<N>) n), functionConstant)) : UndirectedGraphConnections.ofImmutable(Maps.asMap(graph.adjacentNodes(n), functionConstant));
    }
