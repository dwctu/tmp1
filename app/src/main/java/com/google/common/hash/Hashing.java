...
public final class Hashing {
    ...
    public static class Sha256Holder {
        public static final HashFunction SHA_256 = new MessageDigestHashFunction(MessageDigestAlgorithms.SHA_256, "Hashing.sha256()");
    ...
    public static class Sha384Holder {
        public static final HashFunction SHA_384 = new MessageDigestHashFunction(MessageDigestAlgorithms.SHA_384, "Hashing.sha384()");
    ...
    public static class Sha512Holder {
        public static final HashFunction SHA_512 = new MessageDigestHashFunction(MessageDigestAlgorithms.SHA_512, "Hashing.sha512()");
    ...
    public static HashCode combineOrdered(Iterable<HashCode> iterable) {
        ...
        while (it2.hasNext()) {
            ...
            for (int i = 0; i < bArrAsBytes.length; i++) {
                bArr[i] = (byte) ((bArr[i] * URLCodec.ESCAPE_CHAR) ^ bArrAsBytes[i]);
            }
        }
        return HashCode.fromBytesNoCopy(bArr);
    }
    ...
    public static HashFunction hmacSha1(Key key) {
        return new MacHashFunction(MAC.HMACSHA1, key, hmacToString("hmacSha1", key));
    }
    ...
    public static HashFunction hmacSha1(byte[] bArr) {
        return hmacSha1(new SecretKeySpec((byte[]) Preconditions.checkNotNull(bArr), MAC.HMACSHA1));
    }
