...
public abstract class CaseFormat {
    ...
    static {
        CaseFormat caseFormat = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.is(SignatureImpl.SEP), Constants.FILENAME_SEQUENCE_SEPARATOR) { // from class: com.google.common.base.CaseFormat.1
            @Override // com.google.common.base.CaseFormat
            public String convert(CaseFormat caseFormat2, String str) {
                return caseFormat2 == CaseFormat.LOWER_UNDERSCORE ? str.replace(SignatureImpl.SEP, '_') : caseFormat2 == CaseFormat.UPPER_UNDERSCORE ? Ascii.toUpperCase(str.replace(SignatureImpl.SEP, '_')) : super.convert(caseFormat2, str);
            }
        ...
        String str = Config.IN_FIELD_SEPARATOR;
        CaseFormat caseFormat2 = new CaseFormat("LOWER_UNDERSCORE", 1, charMatcherIs, str) { // from class: com.google.common.base.CaseFormat.2
            ...
            public String convert(CaseFormat caseFormat3, String str2) {
                return caseFormat3 == CaseFormat.LOWER_HYPHEN ? str2.replace('_', SignatureImpl.SEP) : caseFormat3 == CaseFormat.UPPER_UNDERSCORE ? Ascii.toUpperCase(str2) : super.convert(caseFormat3, str2);
            }
        ...
        String str2 = "";
        CaseFormat caseFormat3 = new CaseFormat("LOWER_CAMEL", 2, CharMatcher.inRange('A', Matrix.MATRIX_TYPE_ZERO), str2) { // from class: com.google.common.base.CaseFormat.3
            @Override // com.google.common.base.CaseFormat
        ...
        CaseFormat caseFormat4 = new CaseFormat("UPPER_CAMEL", 3, CharMatcher.inRange('A', Matrix.MATRIX_TYPE_ZERO), str2) { // from class: com.google.common.base.CaseFormat.4
            @Override // com.google.common.base.CaseFormat
            public String normalizeWord(String str3) {
                return CaseFormat.firstCharOnlyToUpper(str3);
            }
        ...
        CaseFormat caseFormat5 = new CaseFormat("UPPER_UNDERSCORE", 4, CharMatcher.is('_'), str) { // from class: com.google.common.base.CaseFormat.5
            ...
            public String convert(CaseFormat caseFormat6, String str3) {
                return caseFormat6 == CaseFormat.LOWER_HYPHEN ? Ascii.toLowerCase(str3.replace('_', SignatureImpl.SEP)) : caseFormat6 == CaseFormat.LOWER_UNDERSCORE ? Ascii.toLowerCase(str3) : super.convert(caseFormat6, str3);
            }
