    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            if (Quantiles.containsNaN(dArr)) {
                ...
                while (i < length) {
                    map.put(Integer.valueOf(iArr[i]), Double.valueOf(Double.NaN));
                    i++;
                }
            ...
            while (true) {
                ...
                int i8 = iArr4[i];
                if (i8 == 0) {
                    map2.put(Integer.valueOf(iArr6[i]), Double.valueOf(dArr[i7]));
                } else {
                    map2.put(Integer.valueOf(iArr6[i]), Double.valueOf(Quantiles.interpolate(dArr[i7], dArr[i7 + 1], i8, this.scale)));
                }
                i++;
            }
        }
