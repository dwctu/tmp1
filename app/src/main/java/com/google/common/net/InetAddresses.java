...
public final class InetAddresses {
    ...
    private static String convertDottedQuadToHex(String str) {
        ...
        return strSubstring + Integer.toHexString(((bArrTextToNumericFormatV4[0] & 255) << 8) | (bArrTextToNumericFormatV4[1] & 255)) + SignatureImpl.INNER_SEP + Integer.toHexString((bArrTextToNumericFormatV4[3] & 255) | ((bArrTextToNumericFormatV4[2] & 255) << 8));
    }
