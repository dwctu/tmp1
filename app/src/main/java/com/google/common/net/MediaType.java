...
public final class MediaType {
    ...
    public static final MediaType HTML_UTF_8 = createConstantUtf8("text", XHTMLExtension.ELEMENT);
    ...
    public static final MediaType APPLICATION_BINARY = createConstant("application", ContentTransferEncodingField.ENC_BINARY);
