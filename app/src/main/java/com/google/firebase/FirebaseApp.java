...
public class FirebaseApp {
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        FirebaseTrace.popTrace();
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: dc.uz0
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: dc.tz0
