...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public final void f(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: dc.z21
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: dc.c31
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.a.deleteFirebaseInstallationId();
            }
        });
    }
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: dc.a31
            @Override // java.lang.Runnable
            public final void run() {
                this.a.d();
            }
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: dc.b31
            @Override // java.lang.Runnable
            public final void run() {
                this.a.f(z);
            }
