...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public static final class CrashlyticsReportSessionEventApplicationExecutionSignalEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Signal> {
        ...
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.of("name");
        private static final FieldDescriptor CODE_DESCRIPTOR = FieldDescriptor.of(XHTMLText.CODE);
        private static final FieldDescriptor ADDRESS_DESCRIPTOR = FieldDescriptor.of(MultipleAddresses.Address.ELEMENT);
