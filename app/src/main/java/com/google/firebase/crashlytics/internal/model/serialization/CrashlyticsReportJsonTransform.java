...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                ...
                case "execution":
                    ...
                    break;
                case "internalKeys":
                    builder.setInternalKeys(parseArray(jsonReader, new ObjectParser() { // from class: dc.j11
                ...
                case "customAttributes":
                    builder.setCustomAttributes(parseArray(jsonReader, new ObjectParser() { // from class: dc.j11
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
                            return CrashlyticsReportJsonTransform.parseCustomAttribute(jsonReader2);
                        }
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "appExitInfo":
                    ...
                    break;
                case "threads":
                    builder.setThreads(parseArray(jsonReader, new ObjectParser() { // from class: dc.g11
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
                ...
                case "signal":
                    ...
                    break;
                case "binaries":
                    builder.setBinaries(parseArray(jsonReader, new ObjectParser() { // from class: dc.i11
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "frames":
                    builder.setFrames(parseArray(jsonReader, f11.a));
                    break;
                case "reason":
    ...
    private static CrashlyticsReport.FilesPayload parseNdkPayload(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (strNextName.equals("files")) {
                builder.setFiles(parseArray(jsonReader, new ObjectParser() { // from class: dc.h11
                    @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                    public final Object parse(JsonReader jsonReader2) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                ...
                case "device":
                    ...
                    break;
                case "events":
                    builder.setEvents(parseArray(jsonReader, new ObjectParser() { // from class: dc.e11
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
