    ...
    */
    ...
    private void buildAndPrepareSampleStreamWrappers(long j) {
        ...
        while (i < list2.size()) {
            ...
            int i2 = i;
            HlsSampleStreamWrapper hlsSampleStreamWrapperBuildSampleStreamWrapper = buildSampleStreamWrapper(3, new Uri[]{rendition.url}, new Format[]{rendition.format}, null, Collections.emptyList(), mapDeriveOverridingDrmInitData, j);
