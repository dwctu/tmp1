...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory setDrmSessionManager(@Nullable final DrmSessionManager drmSessionManager) {
            if (drmSessionManager == null) {
                ...
                setDrmSessionManagerProvider(new DrmSessionManagerProvider() { // from class: dc.sv0
                    @Override // com.google.android.exoplayer2.drm.DrmSessionManagerProvider
                    public final DrmSessionManager get(MediaItem mediaItem) {
                        DrmSessionManager drmSessionManager2 = drmSessionManager;
                        HlsMediaSource.Factory.a(drmSessionManager2, mediaItem);
    ...
    private SinglePeriodTimeline createTimelineForLive(HlsMediaPlaylist hlsMediaPlaylist, long j, long j2, HlsManifest hlsManifest) {
        ...
        maybeUpdateLiveConfiguration(Util.constrainValue(j4 != C.TIME_UNSET ? Util.msToUs(j4) : getTargetLiveOffsetUs(hlsMediaPlaylist, liveEdgeOffsetUs), liveEdgeOffsetUs, hlsMediaPlaylist.durationUs + liveEdgeOffsetUs));
