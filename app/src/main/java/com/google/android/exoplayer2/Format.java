...
public final class Format implements Bundleable {
    ...
    public static final Bundleable.Creator<Format> CREATOR = new Bundleable.Creator() { // from class: dc.xm0
        ...
        if (format.drmInitData != null) {
            ...
            while (true) {
                ...
                if (uuid.equals(C.COMMON_PSSH_UUID)) {
                    ...
                    StringBuilder sb2 = new StringBuilder(String.valueOf(strValueOf).length() + 10);
                    sb2.append("unknown (");
    ...
    public Format withManifestFormatInfo(Format format) {
        ...
        return buildUpon().setId(str2).setLabel(str3).setLanguage(str4).setSelectionFlags(this.selectionFlags | format.selectionFlags).setRoleFlags(this.roleFlags | format.roleFlags).setAverageBitrate(i).setPeakBitrate(i2).setCodecs(str5).setMetadata(metadataCopyWithAppendedEntriesFrom).setDrmInitData(DrmInitData.createSessionCreationData(format.drmInitData, this.drmInitData)).setFrameRate(f).build();
    }
