...
public interface Player {
    ...
    public static final class Commands implements Bundleable {
        ...
        public static final Bundleable.Creator<Commands> CREATOR = new Bundleable.Creator() { // from class: dc.hn0
    ...
    public static final class PositionInfo implements Bundleable {
        public static final Bundleable.Creator<PositionInfo> CREATOR = new Bundleable.Creator() { // from class: dc.in0
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
    ...
    void setPlaybackSpeed(@FloatRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, fromInclusive = false) float f);
    ...
    void setVolume(@FloatRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, to = LinkedHashMultimap.VALUE_SET_LOAD_FACTOR) float f);
