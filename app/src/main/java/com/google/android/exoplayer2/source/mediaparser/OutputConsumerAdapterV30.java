...
public final class OutputConsumerAdapterV30 implements MediaParser.OutputConsumer {
    ...
    @Nullable
    private TrackOutput.CryptoData toExoPlayerCryptoData(int i, @Nullable MediaCodec.CryptoInfo cryptoInfo) throws NumberFormatException {
        int i2;
        if (cryptoInfo == null) {
            return null;
        }
