...
public class MatroskaExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: dc.ks0
    ...
    static {
        ...
        map.put("htc_video_rotA-270", Integer.valueOf(Constants.VIDEO_ORIENTATION_270));
    ...
    private int writeSampleData(ExtractorInput extractorInput, Track track, int i) throws IOException {
        ...
        if (!CODEC_ID_H264.equals(track.codecId) && !CODEC_ID_H265.equals(track.codecId)) {
            ...
            while (true) {
                ...
                int iWriteToOutput = writeToOutput(extractorInput, trackOutput, iLimit - i8);
