...
public abstract class MappingTrackSelector extends TrackSelector {
        ...
        for (int i = 0; i < mappedTrackInfo.getRendererCount(); i++) {
            ...
            for (int i2 = 0; i2 < trackGroups.length; i2++) {
                ...
                for (int i4 = 0; i4 < trackGroup.length; i4++) {
                    ...
                    zArr[i4] = (trackSelection == null || trackSelection.getTrackGroup() != trackGroup || trackSelection.indexOf(i4) == -1) ? false : true;
                }
    ...
    private static int findRenderer(RendererCapabilities[] rendererCapabilitiesArr, TrackGroup trackGroup, int[] iArr, boolean z) throws ExoPlaybackException {
        ...
        for (int i2 = 0; i2 < rendererCapabilitiesArr.length; i2++) {
            ...
            for (int i3 = 0; i3 < trackGroup.length; i3++) {
                iMax = Math.max(iMax, zn0.d(rendererCapabilities.supportsFormat(trackGroup.getFormat(i3))));
            }
    ...
    public static final class MappedTrackInfo {
        ...
        public int getTrackSupport(int i, int i2, int i3) {
            return zn0.d(this.rendererFormatSupports[i][i2][i3]);
        }
        ...
        public int getAdaptiveSupport(int i, int i2, int[] iArr) {
            ...
            while (i3 < iArr.length) {
                ...
                iMin = Math.min(iMin, zn0.c(this.rendererFormatSupports[i][i2][i3]));
                i3++;
                i4 = i5;
            }
