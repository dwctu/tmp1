...
public final class PsBinarySearchSeeker extends BinarySearchSeeker {
    ...
    public static final class PsScrSeeker implements BinarySearchSeeker.TimestampSeeker {
        ...
        private BinarySearchSeeker.TimestampSearchResult searchForScrValueInBuffer(ParsableByteArray parsableByteArray, long j, long j2) {
                ...
                if (PsBinarySearchSeeker.peekIntAtPosition(parsableByteArray.getData(), parsableByteArray.getPosition()) != 442) {
                    ...
                    if (scrValueFromPack != C.TIME_UNSET) {
                        ...
                        if (jAdjustTsTimestamp > j) {
                            return j3 == C.TIME_UNSET ? BinarySearchSeeker.TimestampSearchResult.overestimatedResult(jAdjustTsTimestamp, j2) : BinarySearchSeeker.TimestampSearchResult.targetFoundResult(j2 + position2);
                        }
            ...
            return j3 != C.TIME_UNSET ? BinarySearchSeeker.TimestampSearchResult.underestimatedResult(j3, j2 + position) : BinarySearchSeeker.TimestampSearchResult.NO_TIMESTAMP_IN_RANGE_RESULT;
        }
