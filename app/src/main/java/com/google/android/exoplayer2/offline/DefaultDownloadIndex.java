...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public static final class DownloadCursorImpl implements DownloadCursor {
        ...
        public /* synthetic */ boolean isAfterLast() {
            return au0.$default$isAfterLast(this);
        }

        @Override // com.google.android.exoplayer2.offline.DownloadCursor
        public /* synthetic */ boolean isBeforeFirst() {
            return au0.$default$isBeforeFirst(this);
        }
        ...
        public /* synthetic */ boolean isFirst() {
            return au0.$default$isFirst(this);
        }

        @Override // com.google.android.exoplayer2.offline.DownloadCursor
        public /* synthetic */ boolean isLast() {
            return au0.$default$isLast(this);
        }
