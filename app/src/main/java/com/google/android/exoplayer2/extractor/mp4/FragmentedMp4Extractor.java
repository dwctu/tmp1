...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: dc.ns0
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), mehd, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: dc.qs0
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return this.a.modifyTrack((Track) obj);
            }
        });
