...
public final class Cea708Decoder extends CeaDecoder {
    ...
    public static final class Cea708CueInfo {
        private static final Comparator<Cea708CueInfo> LEAST_IMPORTANT_FIRST = new Comparator() { // from class: dc.bw0
    ...
    public static final class CueInfoBuilder {
        ...
        public Cea708CueInfo build() {
            ...
            return new Cea708CueInfo(spannableStringBuilder, alignment2, f4, 0, i4 / 3 == 0 ? 0 : i4 / 3 == 1 ? 1 : 2, f3, i4 % 3 == 0 ? 0 : i4 % 3 == 1 ? 1 : 2, -3.4028235E38f, this.windowFillColor != COLOR_SOLID_BLACK, this.windowFillColor, this.priority);
        }
    ...
    private void handleC1Command(int i) {
        ...
        switch (i) {
            ...
            case 134:
            case 135:
                int i3 = i + BluetoothGatt.GATT_NO_RESOURCES;
