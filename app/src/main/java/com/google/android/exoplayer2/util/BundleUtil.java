...
public final class BundleUtil {
    ...
    @Nullable
    private static IBinder getBinderByReflection(Bundle bundle, @Nullable String str) throws NoSuchMethodException, SecurityException {
    ...
    private static void putBinderByReflection(Bundle bundle, @Nullable String str, @Nullable IBinder iBinder) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
