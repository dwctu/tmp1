...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleDecoderOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
    ...
    public final class AudioSinkListener implements AudioSink.Listener {
        ...
        public /* synthetic */ void onOffloadBufferEmptying() {
            cr0.$default$onOffloadBufferEmptying(this);
        }

        @Override // com.google.android.exoplayer2.audio.AudioSink.Listener
        public /* synthetic */ void onOffloadBufferFull(long j) {
            cr0.$default$onOffloadBufferFull(this, j);
        }
    ...
    private void setDecoderDrmSession(@Nullable DrmSession drmSession) {
        wr0.a(this.decoderDrmSession, drmSession);
    ...
    public final int supportsFormat(Format format) {
        ...
        if (iSupportsFormatInternal <= 2) {
            return zn0.a(iSupportsFormatInternal);
        }
        return zn0.b(iSupportsFormatInternal, 8, Util.SDK_INT >= 21 ? 32 : 0);
    }
