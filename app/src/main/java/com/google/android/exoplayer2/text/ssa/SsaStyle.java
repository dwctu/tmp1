...
public final class SsaStyle {
    ...
    public static SsaStyle fromStyleLine(String str, Format format) {
        ...
        try {
            ...
            float fontSize = i4 != -1 ? parseFontSize(strArrSplit[i4].trim()) : -3.4028235E38f;
            int i5 = format.boldIndex;
            boolean z = i5 != -1 && parseBooleanValue(strArrSplit[i5].trim());
            ...
            return new SsaStyle(strTrim, alignment, color, fontSize, z, z2, z3, i8 != -1 && parseBooleanValue(strArrSplit[i8].trim()));
    ...
    public static Integer parseColor(String str) {
        try {
            ...
            Assertions.checkArgument(j <= UnsignedInts.INT_MASK);
