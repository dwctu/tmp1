...
public interface MediaCodecAdapter {
    ...
    public static final class Configuration {
        ...
        private Configuration(MediaCodecInfo mediaCodecInfo, MediaFormat mediaFormat, Format format, @Nullable Surface surface, @Nullable MediaCrypto mediaCrypto, int i, boolean z) {
