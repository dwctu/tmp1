...
public abstract class BaseTrackSelection implements ExoTrackSelection {
    ...
    public /* synthetic */ void onDiscontinuity() {
        ow0.$default$onDiscontinuity(this);
    }

    @Override // com.google.android.exoplayer2.trackselection.ExoTrackSelection
    public /* synthetic */ void onPlayWhenReadyChanged(boolean z) {
        ow0.$default$onPlayWhenReadyChanged(this, z);
    }
    ...
    public /* synthetic */ void onRebuffer() {
        ow0.$default$onRebuffer(this);
    }

    @Override // com.google.android.exoplayer2.trackselection.ExoTrackSelection
    public /* synthetic */ boolean shouldCancelChunkLoad(long j, Chunk chunk, List list) {
        return ow0.$default$shouldCancelChunkLoad(this, j, chunk, list);
    }
    ...
    public BaseTrackSelection(TrackGroup trackGroup, int[] iArr, int i) {
        ...
        Arrays.sort(this.formats, new Comparator() { // from class: dc.fw0
