...
public final class StyledPlayerControlViewLayoutManager {
    ...
    private final Runnable showAllBarsRunnable = new Runnable() { // from class: dc.px0
        @Override // java.lang.Runnable
        public final void run() {
            this.a.showAllBars();
        }
    };
    private final Runnable hideAllBarsRunnable = new Runnable() { // from class: dc.hx0
        @Override // java.lang.Runnable
        public final void run() {
            this.a.hideAllBars();
        }
    };
    private final Runnable hideProgressBarRunnable = new Runnable() { // from class: dc.lx0
        @Override // java.lang.Runnable
        public final void run() {
            this.a.hideProgressBar();
        }
    };
    private final Runnable hideMainBarRunnable = new Runnable() { // from class: dc.ox0
        @Override // java.lang.Runnable
        public final void run() {
            this.a.hideMainBar();
        }
    };
    private final Runnable hideControllerRunnable = new Runnable() { // from class: dc.ix0
        @Override // java.lang.Runnable
        public final void run() {
            this.a.hideController();
        }
    };
    private final View.OnLayoutChangeListener onLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: dc.jx0
    ...
    public StyledPlayerControlViewLayoutManager(final StyledPlayerControlView styledPlayerControlView) throws Resources.NotFoundException {
        ...
        if (viewFindViewById2 != null && viewFindViewById3 != null) {
            viewFindViewById2.setOnClickListener(new View.OnClickListener() { // from class: dc.nx0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.a.onOverflowButtonClick(view);
                }
            });
            viewFindViewById3.setOnClickListener(new View.OnClickListener() { // from class: dc.nx0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.a.onOverflowButtonClick(view);
                }
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: dc.kx0
        ...
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: dc.gx0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: dc.mx0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        valueAnimatorOfFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: dc.qx0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (this.isMinimalMode != zUseMinimalMode) {
            ...
            view.post(new Runnable() { // from class: dc.ex0
                @Override // java.lang.Runnable
                public final void run() throws Resources.NotFoundException {
                    this.a.updateLayoutForSizeChange();
                }
            });
        }
        ...
        view.post(new Runnable() { // from class: dc.fx0
            @Override // java.lang.Runnable
            public final void run() {
                this.a.onLayoutWidthChanged();
            }
        });
    }
