...
public final class ExoPlaybackException extends PlaybackException {
    public static final Bundleable.Creator<ExoPlaybackException> CREATOR = new Bundleable.Creator() { // from class: dc.yk0
    ...
    private static String deriveMessage(int i, @Nullable String str, @Nullable String str2, int i2, @Nullable Format format, int i3) {
        ...
        if (i == 0) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(str2).length() + 53 + String.valueOf(strValueOf).length() + String.valueOf(formatSupportString).length());
            sb.append(str2);
        ...
        StringBuilder sb2 = new StringBuilder(String.valueOf(strValueOf2).length() + 2 + String.valueOf(str).length());
