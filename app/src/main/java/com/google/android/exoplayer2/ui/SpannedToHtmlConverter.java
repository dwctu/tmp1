...
public final class SpannedToHtmlConverter {
    ...
    public static final class SpanInfo {
        ...
        private static final Comparator<SpanInfo> FOR_OPENING_TAGS = new Comparator() { // from class: dc.uw0
        ...
        private static final Comparator<SpanInfo> FOR_CLOSING_TAGS = new Comparator() { // from class: dc.vw0
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
    ...
    public static HtmlAndCss convert(@Nullable CharSequence charSequence, float f) {
        ...
        while (i < sparseArrayFindSpanTransitions.size()) {
            ...
            sb2.append(escapeHtml(spanned.subSequence(i2, iKeyAt)));
