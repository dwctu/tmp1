    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: dc.wt0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.a.b(downloadService);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void onDownloadsPausedChanged(DownloadManager downloadManager, boolean z) {
            bu0.$default$onDownloadsPausedChanged(this, downloadManager, z);
        }
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new Runnable() { // from class: dc.xt0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.a.update();
                    }
