...
public final class CameraMotionRenderer extends BaseRenderer {
    ...
    public void render(long j, long j2) {
        while (!hasReadStreamToEnd() && this.lastTimestampUs < IndexSeeker.MIN_TIME_BETWEEN_POINTS_US + j) {
            this.buffer.clear();
    ...
    public int supportsFormat(Format format) {
        return MimeTypes.APPLICATION_CAMERA_MOTION.equals(format.sampleMimeType) ? zn0.a(4) : zn0.a(0);
    }
}
