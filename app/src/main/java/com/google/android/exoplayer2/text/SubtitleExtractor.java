...
public class SubtitleExtractor implements Extractor {
    ...
    private void writeToOutput() {
        ...
        for (int iBinarySearchFloor = j == C.TIME_UNSET ? 0 : Util.binarySearchFloor((List<? extends Comparable<? super Long>>) this.timestamps, Long.valueOf(j), true, true); iBinarySearchFloor < this.samples.size(); iBinarySearchFloor++) {
