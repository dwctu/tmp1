...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_CHARACTER_SET = {CipherSuite.TLS_PSK_WITH_AES_128_CBC_SHA256, 176, PsExtractor.PRIVATE_STREAM_1, 191, 8482, 162, 163, 9834, 224, 32, 232, 226, 234, 238, 244, 251};
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {193, 201, 211, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, 192, DownloaderService.STATUS_WAITING_TO_RETRY, Opcodes.IFNONNULL, 200, 202, 203, 235, 206, 207, 239, 212, 217, 249, 219, CipherSuite.TLS_DHE_PSK_WITH_AES_256_GCM_SHA384, Opcodes.NEW};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {DownloaderService.STATUS_WAITING_FOR_NETWORK, 227, 205, 204, 236, 210, 242, 213, 245, 123, EACTags.SECURE_MESSAGING_TEMPLATE, 92, 94, 95, 124, 126, DownloaderService.STATUS_QUEUED_FOR_WIFI_OR_CELLULAR_PERMISSION, 228, 214, 246, 223, 165, CipherSuite.TLS_DH_DSS_WITH_AES_128_GCM_SHA256, 9474, DownloaderService.STATUS_QUEUED_FOR_WIFI, 229, 216, 248, 9484, 9488, 9492, 9496};
