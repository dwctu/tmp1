...
public final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        qk0 qk0Var = new Migration() { // from class: dc.qk0
        ...
        MIGRATE_TO_V1 = qk0Var;
        nk0 nk0Var = new Migration() { // from class: dc.nk0
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) throws SQLException {
                SchemaManager.e(sQLiteDatabase);
            }
        };
        MIGRATE_TO_V2 = nk0Var;
        ok0 ok0Var = new Migration() { // from class: dc.ok0
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) throws SQLException {
                sQLiteDatabase.execSQL("ALTER TABLE events ADD COLUMN payload_encoding TEXT");
            }
        };
        MIGRATE_TO_V3 = ok0Var;
        pk0 pk0Var = new Migration() { // from class: dc.pk0
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) throws SQLException {
                SchemaManager.j(sQLiteDatabase);
            }
        };
        MIGRATE_TO_V4 = pk0Var;
        rk0 rk0Var = new Migration() { // from class: dc.rk0
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) throws SQLException {
                SchemaManager.m(sQLiteDatabase);
            }
        };
        MIGRATION_TO_V5 = rk0Var;
        INCREMENTAL_MIGRATIONS = Arrays.asList(qk0Var, nk0Var, ok0Var, pk0Var, rk0Var);
    }
