...
public final class CctTransportBackend implements TransportBackend {
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(urlOrThrow, requestBody, aPIKey), new Function() { // from class: dc.ui0
                @Override // com.google.android.datatransport.runtime.retries.Function
                public final Object apply(Object obj) {
                    return this.a.doSend((CctTransportBackend.HttpRequest) obj);
                }
            }, new RetryStrategy() { // from class: dc.ti0
