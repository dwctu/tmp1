...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        ...
        attributeSet.getAttributeIntValue("http://schemas.android.com/apk/res/android", Toy.TOY_FEATURE_GRAVITY, 8388627);
    }
    ...
    */
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable chipDrawableCreateFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, i2);
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, com.google.android.material.R.styleable.Chip, i, i2, new int[0]);
