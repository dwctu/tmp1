...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(@NonNull MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(VideoCaptureFormat.keyWidth)) {
            arrayList.add(motionSpec.getAnimator(VideoCaptureFormat.keyWidth, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(VideoCaptureFormat.keyHeight)) {
            arrayList.add(motionSpec.getAnimator(VideoCaptureFormat.keyHeight, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
