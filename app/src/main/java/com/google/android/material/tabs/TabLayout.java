...
public class TabLayout extends HorizontalScrollView {
    ...
    */
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) throws Resources.NotFoundException {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, iArr, i, i2, i3);
        ...
        try {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i4)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, i4);
            }
