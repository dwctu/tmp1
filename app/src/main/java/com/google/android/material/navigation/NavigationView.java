...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) throws Resources.NotFoundException {
        ...
        int i2 = com.google.android.material.R.styleable.NavigationView_android_background;
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i2)) {
            ViewCompat.setBackground(this, tintTypedArrayObtainTintedStyledAttributes.getDrawable(i2));
        }
        ...
        int i5 = com.google.android.material.R.styleable.NavigationView_itemIconSize;
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i5)) {
            setItemIconSize(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(i5, 0));
        }
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i7)) {
            navigationMenuPresenter.setItemHorizontalPadding(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(i7, 0));
        }
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i9)) {
            inflateHeaderView(tintTypedArrayObtainTintedStyledAttributes.getResourceId(i9, 0));
        }
