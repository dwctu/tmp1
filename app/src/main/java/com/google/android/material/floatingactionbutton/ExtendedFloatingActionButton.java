...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(VideoCaptureFormat.keyWidth)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(VideoCaptureFormat.keyWidth);
                propertyValues[0].setFloatValues(ExtendedFloatingActionButton.this.getWidth(), this.size.getWidth());
                currentMotionSpec.setPropertyValues(VideoCaptureFormat.keyWidth, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(VideoCaptureFormat.keyHeight)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(VideoCaptureFormat.keyHeight);
                propertyValues2[0].setFloatValues(ExtendedFloatingActionButton.this.getHeight(), this.size.getHeight());
                currentMotionSpec.setPropertyValues(VideoCaptureFormat.keyHeight, propertyValues2);
            }
    ...
    static {
        ...
        WIDTH = new Property<View, Float>(cls, VideoCaptureFormat.keyWidth) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.4
        ...
        HEIGHT = new Property<View, Float>(cls, VideoCaptureFormat.keyHeight) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.5
            @Override // android.util.Property
            @NonNull
            public Float get(@NonNull View view) {
