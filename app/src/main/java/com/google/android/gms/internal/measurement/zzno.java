...
public final class zzno implements zznn {
    ...
    static {
        ...
        zzi = zzhxVarZza.zzd("measurement.store.max_stored_events_per_app", IndexSeeker.MIN_TIME_BETWEEN_POINTS_US);
        ...
        zzx = zzhxVarZza.zzd("measurement.upload.initial_upload_delay_time", C.DEFAULT_SEEK_FORWARD_INCREMENT_MS);
        ...
        zzE = zzhxVarZza.zzd("measurement.upload.max_events_per_day", IndexSeeker.MIN_TIME_BETWEEN_POINTS_US);
