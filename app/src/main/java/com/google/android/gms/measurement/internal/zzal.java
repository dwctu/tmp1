...
public final class zzal extends SQLiteOpenHelper {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) throws Throwable {
        ...
        zzan.zza(this.zza.zzs.zzay(), sQLiteDatabase, SyncWsProtocol.DataBean.CONTROL_STATUS_QUEUE_TYPE_KEY, "CREATE TABLE IF NOT EXISTS queue ( app_id TEXT NOT NULL, bundle_end_timestamp INTEGER NOT NULL, data BLOB NOT NULL);", "app_id,bundle_end_timestamp,data", zzam.zze);
