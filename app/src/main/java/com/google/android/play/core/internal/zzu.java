...
public interface zzu extends IInterface {
    void zzc(String str, List list, Bundle bundle, zzw zzwVar) throws RemoteException;
    ...
    void zzj(String str, Bundle bundle, Bundle bundle2, zzw zzwVar) throws RemoteException;

    void zzk(String str, List list, Bundle bundle, zzw zzwVar) throws RemoteException;

    void zzl(String str, List list, Bundle bundle, zzw zzwVar) throws RemoteException;
}
