...
public class GroupPatternSaveMemberAdapter extends BaseAdapter<ResponsePatternOrAlarmMessage.DataBean> {
    public GroupPatternSaveMemberAdapter(ArrayList<ResponsePatternOrAlarmMessage.DataBean> arrayList, int i) {
        super(arrayList, i);
    }
