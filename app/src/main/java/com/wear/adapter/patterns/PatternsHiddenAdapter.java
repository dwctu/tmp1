...
public class PatternsHiddenAdapter extends RecyclerView.Adapter<PatternViewHolder> {
    ...
    public class a implements kn3.d {
        ...
        public void doConfirm() {
            pj3.t(PatternsHiddenAdapter.this.b, LoginActivity.class, 2);
        }
    }
    ...
    public class b implements zn2<String> {
        ...
        public void onError(NetException netException) {
            sg3.k(PatternsHiddenAdapter.this.b, netException.getMessage());
        }
    }
    ...
    public class c implements zn2<String> {
        ...
        public void onSuccess(String str) {
            ...
            if (normalResponse == null) {
                sg3.i(PatternsHiddenAdapter.this.b, R.string.patterns_result_remove_failed);
            } else {
    ...
    public class d implements ao3.a {
        public d(PatternsHiddenAdapter patternsHiddenAdapter) {
        }
    ...
    public class e implements yn3.c {
        ...
        public /* synthetic */ void c(String str, String str2, Pattern pattern, String str3) throws IOException {
            if (WearUtils.e1(str3)) {
                sg3.i(PatternsHiddenAdapter.this.b, R.string.file_notfound);
                return;
            }
        ...
        public void a(String str, final String str2) {
            ...
            nf3.b(str, new nf3.d() { // from class: dc.ln1
                @Override // dc.nf3.d
    ...
    public interface f {
        void C0(PatternViewHolder patternViewHolder, Pattern pattern);
    ...
    public PatternsHiddenAdapter(List<Pattern> list, Context context) {
        this.a = list;
        this.b = context;
    }
    ...
    public /* synthetic */ void B(Pattern pattern, View view) {
        ...
        if (pattern.getToySymbol() != null) {
            bundle.putString("toySymbol", pattern.getToySymbol());
        }
        if (pattern.getToyName() != null) {
            bundle.putString("toyName", pattern.getToyName());
        }
        if (pattern.getToyVersion() != null) {
    ...
    public /* synthetic */ void D(ao3 ao3Var, Pattern pattern, View view) {
        f fVar;
        ao3Var.dismiss();
        if (WearUtils.y.u() == null || (fVar = this.d) == null) {
            return;
        }
        fVar.g(pattern);
    }
    ...
    public /* synthetic */ void F(final Pattern pattern, final int i, View view) {
        ...
        ao3Var.a(view, 250, (WearUtils.e1(pattern.getEmail()) || !pattern.getEmail().contains(WearUtils.y.r())) ? CipherSuite.TLS_RSA_WITH_SEED_CBC_SHA : 200, 5160, -30, new d(this));
        ao3Var.findViewById(R.id.action_row_2).setOnClickListener(new View.OnClickListener() { // from class: dc.mn1
        ...
        if ("Lovense-pick".equals(pattern.getTagName()) || AppMeasurementSdk.ConditionalUserProperty.ACTIVE.equals(pattern.getStatus())) {
            ...
            ao3Var.findViewById(R.id.action_row_3).setOnClickListener(new View.OnClickListener() { // from class: dc.tn1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        if (MyApplication.Z || WearUtils.e1(pattern.getEmail()) || !pattern.getEmail().equals(WearUtils.y.r())) {
            ...
            ao3Var.findViewById(R.id.ll_row_1).setOnClickListener(new View.OnClickListener() { // from class: dc.rn1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        if (MyApplication.Z) {
            ((LinearLayout) ao3Var.findViewById(R.id.ll_row_4)).setVisibility(MyApplication.Z ? 8 : 0);
        }
        ((TextView) ao3Var.findViewById(R.id.action_row_4_text)).setText(ah4.e(R.string.privacy_hidden_patterns_Show_button));
        ((ImageView) ao3Var.findViewById(R.id.action_row_4_icon)).setImageResource(R.drawable.pattern_more_unhide);
        ao3Var.findViewById(R.id.action_row_4).setOnClickListener(new View.OnClickListener() { // from class: dc.on1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
    ...
    public /* synthetic */ void J(PatternViewHolder patternViewHolder, Pattern pattern) {
        if (!na2.m().t() && y12.c.a().s(y12.c.TYPE_PATTERN)) {
            ...
            f fVar = this.d;
            if (fVar != null) {
                fVar.C0(patternViewHolder, pattern);
            }
        }
    }
    ...
    public /* synthetic */ void x(ao3 ao3Var, int i, View view) {
        ...
        if (WearUtils.y.u() == null) {
            S(R.string.pattern_store_share_offline_notification);
            return;
        }
    ...
    public /* synthetic */ void z(ao3 ao3Var, Pattern pattern, View view) {
        ao3Var.dismiss();
        if (WearUtils.y.u() == null) {
            S(R.string.pattern_store_report_offline_notification);
            return;
        }
        f fVar = this.d;
        if (fVar != null) {
    ...
    public void onBindViewHolder(@NonNull PatternViewHolder patternViewHolder, int i) {
        ...
        if (!WearUtils.e1(pattern.getStatus()) && (pattern.getStatus().equalsIgnoreCase("report") || pattern.getStatus().equalsIgnoreCase("removed"))) {
            ...
            R(pattern, patternViewHolder.patternPlayCurve);
            ...
            patternViewHolder.ivRemovedAction.setOnClickListener(new View.OnClickListener() { // from class: dc.qn1
                @Override // android.view.View.OnClickListener
    ...
    public final void N(@NonNull final PatternViewHolder patternViewHolder, final Pattern pattern) {
        db2.A().q(new db2.s() { // from class: dc.nn1
            @Override // dc.db2.s
            public final void a() {
    ...
    public final void R(Pattern pattern, NewCurveLineView newCurveLineView) {
        if (pattern == null) {
            return;
        }
    ...
    public final void T(Pattern pattern, String str, Pattern pattern2) {
    ...
    public long getItemId(int i) {
        return this.a.get(i) != null ? this.a.get(i).getId().hashCode() + this.a.get(i).getCdtTime() : i;
    }

    public final void l(Pattern pattern) {
        if (WearUtils.y.u() == null) {
            S(R.string.pattern_store_like_offline_notification);
            return;
        }
    ...
    public final void m(@NonNull final PatternViewHolder patternViewHolder, final int i, final Pattern pattern) {
        patternViewHolder.ivPatternLike.setOnClickListener(new View.OnClickListener() { // from class: dc.un1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.a.r(pattern, view);
            }
        });
        patternViewHolder.patternPlay.setOnClickListener(new View.OnClickListener() { // from class: dc.sn1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.a.t(patternViewHolder, pattern, view);
            }
        });
        patternViewHolder.ivPatternDownload.setOnClickListener(new View.OnClickListener() { // from class: dc.pn1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.a.v(pattern, view);
            }
        });
        patternViewHolder.patternHiden.setOnClickListener(new View.OnClickListener() { // from class: dc.kn1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
