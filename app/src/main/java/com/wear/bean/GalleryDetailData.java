...
public final /* data */ class GalleryDetailData {
    ...
    @NotNull
    public final GalleryDetailData copy(@Nullable String applicationCoverImgUrl, @Nullable String applicationId, @Nullable String applicationLogoUrl, @Nullable String applicationName, @Nullable String applicationSynopsis, @Nullable String applicationUrl, @Nullable String applicationVersion, @Nullable List<String> dataRequiredList, @Nullable String developerName, @Nullable String previewImgOrientation, @Nullable List<String> previewImgUlrList, @Nullable String previewText, @Nullable List<String> xremoteAllowDomainList, @Nullable String xremoteApiVersion) {
        return new GalleryDetailData(applicationCoverImgUrl, applicationId, applicationLogoUrl, applicationName, applicationSynopsis, applicationUrl, applicationVersion, dataRequiredList, developerName, previewImgOrientation, previewImgUlrList, previewText, xremoteAllowDomainList, xremoteApiVersion);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof GalleryDetailData)) {
            return false;
        }
        GalleryDetailData galleryDetailData = (GalleryDetailData) other;
        return Intrinsics.areEqual(this.applicationCoverImgUrl, galleryDetailData.applicationCoverImgUrl) && Intrinsics.areEqual(this.applicationId, galleryDetailData.applicationId) && Intrinsics.areEqual(this.applicationLogoUrl, galleryDetailData.applicationLogoUrl) && Intrinsics.areEqual(this.applicationName, galleryDetailData.applicationName) && Intrinsics.areEqual(this.applicationSynopsis, galleryDetailData.applicationSynopsis) && Intrinsics.areEqual(this.applicationUrl, galleryDetailData.applicationUrl) && Intrinsics.areEqual(this.applicationVersion, galleryDetailData.applicationVersion) && Intrinsics.areEqual(this.dataRequiredList, galleryDetailData.dataRequiredList) && Intrinsics.areEqual(this.developerName, galleryDetailData.developerName) && Intrinsics.areEqual(this.previewImgOrientation, galleryDetailData.previewImgOrientation) && Intrinsics.areEqual(this.previewImgUlrList, galleryDetailData.previewImgUlrList) && Intrinsics.areEqual(this.previewText, galleryDetailData.previewText) && Intrinsics.areEqual(this.xremoteAllowDomainList, galleryDetailData.xremoteAllowDomainList) && Intrinsics.areEqual(this.xremoteApiVersion, galleryDetailData.xremoteApiVersion);
    }
