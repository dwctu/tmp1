...
public class DSTargeterRefuseInviteResponse {
    ...
    public Object getCurrentPlayerJid() {
    ...
    public int getPlayerStartControlTime() {
    ...
    public void setCurrentPlayerJid(Object obj) {
        this.currentPlayerJid = obj;
    }
    ...
    public void setPlayerStartControlTime(int i) {
        this.playerStartControlTime = i;
    }
