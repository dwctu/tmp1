...
public final class LinearContentContainer extends LinearLayout implements su2 {
    ...
    @JvmOverloads
    public LinearContentContainer(@Nullable Context context) {
    ...
    @JvmOverloads
    public LinearContentContainer(@Nullable Context context, @Nullable AttributeSet attributeSet, int i) {
    ...
    public final void e(AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, vi1.LinearContentContainer, i, 0);
    ...
    public void onFinishInflate() {
        ...
        EditText editTextG = getH().g();
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(1, 1);
        layoutParams.topMargin = -1;
        addView(editTextG, 0, layoutParams);
    }
    ...
    public /* synthetic */ LinearContentContainer(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
