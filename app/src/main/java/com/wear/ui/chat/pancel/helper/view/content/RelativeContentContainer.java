...
public final class RelativeContentContainer extends RelativeLayout implements su2 {
    ...
    public final void e(AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, vi1.RelativeContentContainer, i, 0);
    ...
    public void onFinishInflate() {
        ...
        addView(getH().g(), 0, new RelativeLayout.LayoutParams(1, 1));
    }
    ...
    public /* synthetic */ RelativeContentContainer(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
