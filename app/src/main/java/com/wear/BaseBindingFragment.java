...
public abstract class BaseBindingFragment<VB extends ViewBinding> extends Fragment {
    ...
    public BaseBindingFragment(@NotNull Function3<? super LayoutInflater, ? super ViewGroup, ? super Boolean, ? extends VB> inflate) {
