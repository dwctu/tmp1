...
public class ChatRoomInputPanel extends ChatInputPanelPto {
    ...
    public BaseImageButton chat_voice;
    ...
    public ChatRoomInputPanel(Context context) {
        this(context, null);
    }
    ...
    public void s(ViewGroup viewGroup) {
        this.voiceMessagePanelView.p(this.ll_chat_input_panel, viewGroup, true);
    }
    ...
    public ChatRoomInputPanel(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        ButterKnife.bind(this, LayoutInflater.from(context).inflate(R.layout.layout_chat_room_input_panel, (ViewGroup) this, true));
