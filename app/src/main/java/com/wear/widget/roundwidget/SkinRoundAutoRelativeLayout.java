...
public final class SkinRoundAutoRelativeLayout extends AutoRelativeLayout implements aj4 {
    ...
    public SkinRoundAutoRelativeLayout(@Nullable Context context) {
        this(context, null);
    }
    ...
    public SkinRoundAutoRelativeLayout(@Nullable Context context, @Nullable AttributeSet attributeSet) {
    ...
    public SkinRoundAutoRelativeLayout(@Nullable Context context, @Nullable AttributeSet attributeSet, int i) {
