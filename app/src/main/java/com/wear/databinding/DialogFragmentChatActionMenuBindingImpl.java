...
public class DialogFragmentChatActionMenuBindingImpl extends DialogFragmentChatActionMenuBinding {
    ...
    public DialogFragmentChatActionMenuBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public DialogFragmentChatActionMenuBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
