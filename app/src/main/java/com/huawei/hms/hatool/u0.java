...
public abstract class u0 {
    ...
    public static String a(String str, String str2, String str3) {
        ...
        return str + Constants.FILENAME_SEQUENCE_SEPARATOR + str2 + "#" + str3;
    }
    ...
    public static Set<String> a(Set<String> set) {
        ...
        for (String str : set) {
            if ("_default_config_tag".equals(str)) {
                ...
                String str2 = str + Constants.FILENAME_SEQUENCE_SEPARATOR + "oper";
                String str3 = str + Constants.FILENAME_SEQUENCE_SEPARATOR + "maint";
                String str4 = str + Constants.FILENAME_SEQUENCE_SEPARATOR + "diffprivacy";
                hashSet.add(str2);
                hashSet.add(str3);
                hashSet.add(str4);
            }
