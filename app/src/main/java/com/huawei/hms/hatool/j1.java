...
public class j1 {
    ...
    public void a(int i) {
        y.b("hmsSdk", "HiAnalyticsInstance.onReport() is execute.TAG: %s,TYPE: %d", this.a, Integer.valueOf(i));
        i1.a().a(this.a, i);
    }

    public void a(int i, String str, LinkedHashMap<String, String> linkedHashMap) throws JSONException {
        y.b("hmsSdk", "HiAnalyticsInstance.onEvent(int type, String eventId, Map<String, String> mapValue) is execute.TAG: %s,TYPE: %d, eventId: %s", this.a, Integer.valueOf(i), str);
        if (s0.a(str) || !c(i)) {
    ...
    public void a(Context context, String str, String str2) throws JSONException {
        y.d("hmsSdk", "HiAnalyticsInstance.onEvent(eventId, mapValue) is execute.TAG : " + this.a + ", eventId : " + str);
        if (context == null) {
