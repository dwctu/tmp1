...
public final class MLApplicationSetting {
    ...
    public static MLApplicationSetting fromResource(Context context) {
        ...
        String metadata = getMetadata(context, BundleKeyConstants.AppInfo.mlSdkVersion, "");
        if (TextUtils.isEmpty(metadata)) {
            metadata = getKitMetadata(context, BundleKeyConstants.AppInfo.mlSdkVersion, GrsBaseInfo.CountryCodeSource.UNKNOWN);
        }
