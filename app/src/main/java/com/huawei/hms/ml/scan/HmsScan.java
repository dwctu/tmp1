...
public class HmsScan extends HmsScanBase {
    ...
    public HmsScan(String str, int i, String str2, int i2, byte[] bArr, Point[] pointArr, HmsScanAnalyzerOptions hmsScanAnalyzerOptions, F f) {
        super(str, i, str2, i2, bArr, pointArr, hmsScanAnalyzerOptions);
        if (f == null || f.a() == null || i2 == ARTICLE_NUMBER_FORM) {
            return;
        }
        if (i2 == EMAIL_CONTENT_FORM) {
            this.emailContent = (EmailContent) f.a();
            return;
        }
        if (i2 == TEL_PHONE_NUMBER_FORM) {
            this.telPhoneNumber = (TelPhoneNumber) f.a();
            return;
        }
        if (i2 == PURE_TEXT_FORM) {
            return;
        ...
        if (i2 == SMS_FORM) {
            this.smsContent = (SmsContent) f.a();
            return;
        }
        if (i2 == URL_FORM) {
            this.linkUrl = (LinkUrl) f.a();
            return;
        }
        if (i2 == WIFI_CONNECT_INFO_FORM) {
            this.wifiConnectionInfo = (WiFiConnectionInfo) f.a();
            return;
        }
        if (i2 == EVENT_INFO_FORM) {
            this.eventInfo = (EventInfo) f.a();
            return;
        }
        if (i2 == CONTACT_DETAIL_FORM) {
            this.contactDetail = (ContactDetail) f.a();
            return;
        }
        if (i2 == DRIVER_INFO_FORM) {
            this.driverInfo = (DriverInfo) f.a();
        } else if (i2 == LOCATION_COORDINATE_FORM) {
            this.locationCoordinate = (LocationCoordinate) f.a();
        } else {
            int i3 = ISBN_NUMBER_FORM;
        }
    }
