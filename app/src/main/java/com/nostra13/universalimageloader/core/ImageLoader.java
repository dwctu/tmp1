...
public class ImageLoader {
    ...
    public void displayImage(String str, ImageAware imageAware, DisplayImageOptions displayImageOptions, ImageLoadingListener imageLoadingListener, ImageLoadingProgressListener imageLoadingProgressListener) {
        ...
        if (imageAware != null) {
            ...
            String strGenerateKey = MemoryCacheUtils.generateKey(str, imageSizeDefineTargetSizeForView);
            ...
            if (bitmap != null && !bitmap.isRecycled()) {
                ...
                if (displayImageOptions.shouldPostProcess()) {
                    ProcessAndDisplayImageTask processAndDisplayImageTask = new ProcessAndDisplayImageTask(this.engine, bitmap, new ImageLoadingInfo(str, imageAware, imageSizeDefineTargetSizeForView, strGenerateKey, displayImageOptions, imageLoadingListener2, imageLoadingProgressListener, this.engine.getLockForUri(str)), defineHandler(displayImageOptions));
                    if (displayImageOptions.isSyncLoading()) {
            ...
            LoadAndDisplayImageTask loadAndDisplayImageTask = new LoadAndDisplayImageTask(this.engine, new ImageLoadingInfo(str, imageAware, imageSizeDefineTargetSizeForView, strGenerateKey, displayImageOptions, imageLoadingListener2, imageLoadingProgressListener, this.engine.getLockForUri(str)), defineHandler(displayImageOptions));
            if (displayImageOptions.isSyncLoading()) {
