...
public class LruDiscCache implements DiskCache {
    ...
    public LruDiscCache(File file, FileNameGenerator fileNameGenerator, long j) throws IOException {
    ...
    */
    ...
    public LruDiscCache(File file, File file2, FileNameGenerator fileNameGenerator, long j, int i) throws IOException {
