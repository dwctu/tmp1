...
public final class BrvahListUpdateCallback implements ListUpdateCallback {
    ...
    public void onChanged(int position, int count, @Nullable Object payload) {
        ...
        baseQuickAdapter.notifyItemRangeChanged(position + baseQuickAdapter.Q(), count, payload);
    }

    @Override // androidx.recyclerview.widget.ListUpdateCallback
    public void onInserted(int position, int count) {
        BaseQuickAdapter<?, ?> baseQuickAdapter = this.a;
        baseQuickAdapter.notifyItemRangeInserted(position + baseQuickAdapter.Q(), count);
    }

    @Override // androidx.recyclerview.widget.ListUpdateCallback
    public void onMoved(int fromPosition, int toPosition) {
        BaseQuickAdapter<?, ?> baseQuickAdapter = this.a;
        baseQuickAdapter.notifyItemMoved(fromPosition + baseQuickAdapter.Q(), toPosition + this.a.Q());
    }
    ...
    public void onRemoved(int position, int count) {
        ...
        if (z && this.a.getItemCount() == 0) {
            BaseQuickAdapter<?, ?> baseQuickAdapter = this.a;
            baseQuickAdapter.notifyItemRangeRemoved(position + baseQuickAdapter.Q(), count + 1);
        } else {
            BaseQuickAdapter<?, ?> baseQuickAdapter2 = this.a;
            baseQuickAdapter2.notifyItemRangeRemoved(position + baseQuickAdapter2.Q(), count);
        }
    }
}
