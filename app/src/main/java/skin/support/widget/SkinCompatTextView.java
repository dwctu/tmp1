...
public class SkinCompatTextView extends AppCompatTextView implements aj4, bh4 {
    public bj4 a;
    public si4 b;
    public int c;
    public Object[] d;
    ...
    public void a() {
        ...
        if (objArr == null || objArr.length == 0) {
            ...
            if (i != 0) {
                ...
                String str = "flashText: " + ah4.e(this.c);
                String str2 = "flashText vluas: " + ah4.e(this.c);
                setTextT(ah4.e(this.c));
                return;
            }
            return;
        }
        ...
        if (this.c == 2131690030) {
            String str3 = "flashText: " + ah4.e(this.c);
            String str4 = "flashText vluas: " + String.format(ah4.e(this.c), objArr2);
        }
        setText(String.format(ah4.e(this.c), objArr2));
    }
    ...
    public void setTextT(String str) {
        String str2 = "flashText setTextT: " + ah4.e(this.c);
        setText(String.format(str, 30));
    }
