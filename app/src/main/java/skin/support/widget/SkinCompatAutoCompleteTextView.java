...
public class SkinCompatAutoCompleteTextView extends AppCompatAutoCompleteTextView implements aj4 {
    ...
    public SkinCompatAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, kh4.autoCompleteTextViewStyle);
    }
