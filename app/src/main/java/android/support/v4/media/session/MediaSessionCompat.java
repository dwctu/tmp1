        ...
        if (list != null) {
            ...
            for (QueueItem queueItem : list) {
                ...
                if (hashSet.contains(Long.valueOf(queueItem.getQueueId()))) {
                    String str = "Found duplicate queue id: " + queueItem.getQueueId();
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (i >= 21) {
                    ...
                    this.mImpl = new MediaSessionImplApi19(context, str, mediaButtonReceiverComponent, pendingIntent2, versionedParcelable, bundle);
                } else if (i >= 18) {
                    this.mImpl = new MediaSessionImplApi18(context, str, mediaButtonReceiverComponent, pendingIntent2, versionedParcelable, bundle);
                } else {
                    this.mImpl = new MediaSessionImplBase(context, str, mediaButtonReceiverComponent, pendingIntent2, versionedParcelable, bundle);
                }
