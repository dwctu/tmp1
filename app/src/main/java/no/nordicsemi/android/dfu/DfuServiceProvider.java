...
public class DfuServiceProvider implements DfuCallback {
    ...
    public DfuService getServiceImpl(@NonNull Intent intent, @NonNull DfuBaseService dfuBaseService, @NonNull BluetoothGatt bluetoothGatt) throws UploadAbortedException, DfuException, DeviceDisconnectedException {
