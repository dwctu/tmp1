...
public final class KTypesJvm {
    ...
    public static final KClass<?> getJvmErasure(@NotNull KClassifier kClassifier) {
        ...
        while (true) {
            ...
            ClassifierDescriptor classifierDescriptorMo1382getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo1382getDeclarationDescriptor();
            classDescriptor = classifierDescriptorMo1382getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1382getDeclarationDescriptor : null;
