...
public final class ReflectJvmMapping {
    ...
    public static final <T> Constructor<T> getJavaConstructor(@NotNull KFunction<? extends T> kFunction) {
        ...
        Member memberMo1369getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo1369getMember();
        if (memberMo1369getMember instanceof Constructor) {
            return (Constructor) memberMo1369getMember;
        }
        return null;
    }
    ...
    public static final Method getJavaMethod(@NotNull KFunction<?> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo1369getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo1369getMember();
        if (memberMo1369getMember instanceof Method) {
            return (Method) memberMo1369getMember;
        }
        return null;
    }
