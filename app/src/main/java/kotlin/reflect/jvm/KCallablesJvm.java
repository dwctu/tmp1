...
public final class KCallablesJvm {
    public static final boolean isAccessible(@NotNull KCallable<?> kCallable) {
        ...
        if (kCallable instanceof KMutableProperty) {
            ...
            Object objMo1369getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo1369getMember();
            AccessibleObject accessibleObject = objMo1369getMember instanceof AccessibleObject ? (AccessibleObject) objMo1369getMember : null;
    ...
    public static final void setAccessible(@NotNull KCallable<?> kCallable, boolean z) throws SecurityException {
        Caller<?> defaultCaller;
        Intrinsics.checkNotNullParameter(kCallable, "<this>");
        if (kCallable instanceof KMutableProperty) {
            KProperty kProperty = (KProperty) kCallable;
