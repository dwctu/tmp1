...
public class KProperty0Impl<V> extends KPropertyImpl<V> implements KProperty0<V> {
    ...
    public KProperty0Impl(@NotNull KDeclarationContainerImpl container, @NotNull PropertyDescriptor descriptor) {
        ...
        ReflectProperties.LazyVal<Getter<V>> lazyValLazy = ReflectProperties.lazy(new Function0<Getter<? extends V>>(this) { // from class: kotlin.reflect.jvm.internal.KProperty0Impl$_getter$1
        ...
        this.delegateValue = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<Object>(this) { // from class: kotlin.reflect.jvm.internal.KProperty0Impl$delegateValue$1
            public final /* synthetic */ KProperty0Impl<V> this$0;
