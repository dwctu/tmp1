...
public final class UtilKt {
    ...
    */
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        ClassifierDescriptor classifierDescriptorMo1382getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1382getDeclarationDescriptor();
    ...
    private static final List<Annotation> unwrapRepeatableAnnotations(List<? extends Annotation> list) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        for (Annotation annotation : list) {
            ...
            if (!Intrinsics.areEqual(javaClass.getSimpleName(), "Container") || javaClass.getAnnotation(RepeatableContainer.class) == null) {
                listListOf = CollectionsKt__CollectionsJVMKt.listOf(annotation);
            } else {
                ...
                listListOf = ArraysKt___ArraysJvmKt.asList((Annotation[]) objInvoke);
            }
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i) {
        ...
        String str3 = str + FilenameUtils.EXTENSION_SEPARATOR + StringsKt__StringsJVMKt.replace$default(str2, FilenameUtils.EXTENSION_SEPARATOR, Typography.dollar, false, 4, (Object) null);
        if (i > 0) {
            str3 = StringsKt__StringsJVMKt.repeat("[", i) + Matrix.MATRIX_TYPE_RANDOM_LT + str3 + ';';
        }
