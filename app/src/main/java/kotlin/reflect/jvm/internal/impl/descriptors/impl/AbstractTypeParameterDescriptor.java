...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo1385reportSupertypeLoopError(kotlinType);
        }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo1383getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo1383getSupertypes();
        if (listMo1383getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo1383getSupertypes;
    }
    ...
    public abstract void mo1385reportSupertypeLoopError(@NotNull KotlinType kotlinType);
