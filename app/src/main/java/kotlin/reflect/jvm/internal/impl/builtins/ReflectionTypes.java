...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor classifierDescriptorMo1384getContributedClassifier = getKotlinReflectScope().mo1384getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
        ...
        return classDescriptor == null ? this.notFoundClasses.getClass(new ClassId(StandardNames.KOTLIN_REFLECT_FQ_NAME, nameIdentifier), CollectionsKt__CollectionsJVMKt.listOf(Integer.valueOf(i))) : classDescriptor;
    }
