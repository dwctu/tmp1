...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    public ClassDescriptor createClass(@NotNull ClassId classId) {
        ...
        if (!StringsKt__StringsKt.contains$default((CharSequence) strAsString, (CharSequence) "Function", false, 2, (Object) null)) {
            return null;
        }
    ...
    public boolean shouldCreateClass(@NotNull FqName packageFqName, @NotNull Name name) {
        ...
        return (StringsKt__StringsJVMKt.startsWith$default(strAsString, "Function", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(strAsString, "KFunction", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(strAsString, "SuspendFunction", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(strAsString, "KSuspendFunction", false, 2, null)) && FunctionClassKind.Companion.parseClassName(strAsString, packageFqName) != null;
    }
}
