...
public final class UtilsKt {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        m1392debugInfo$lambda1$unaryPlus("type: " + typeConstructor, sb);
        m1392debugInfo$lambda1$unaryPlus("hashCode: " + typeConstructor.hashCode(), sb);
        m1392debugInfo$lambda1$unaryPlus("javaClass: " + typeConstructor.getClass().getCanonicalName(), sb);
        for (DeclarationDescriptor declarationDescriptorMo1382getDeclarationDescriptor = typeConstructor.mo1382getDeclarationDescriptor(); declarationDescriptorMo1382getDeclarationDescriptor != null; declarationDescriptorMo1382getDeclarationDescriptor = declarationDescriptorMo1382getDeclarationDescriptor.getContainingDeclaration()) {
            m1392debugInfo$lambda1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptorMo1382getDeclarationDescriptor), sb);
            m1392debugInfo$lambda1$unaryPlus("javaClass: " + declarationDescriptorMo1382getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
    ...
    private static final StringBuilder m1392debugInfo$lambda1$unaryPlus(String str, StringBuilder sb) {
    ...
    public static final KotlinType findCorrespondingSupertype(@NotNull KotlinType subtype, @NotNull KotlinType supertype, @NotNull TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType immediateSupertype : constructor2.mo1383getSupertypes()) {
