    ...
    public AbstractTypeAliasDescriptor(@NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, @NotNull Name name, @NotNull SourceElement sourceElement, @NotNull DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1382getDeclarationDescriptor());
            }
            ...
            public Collection<KotlinType> mo1383getSupertypes() {
                Collection<KotlinType> collectionMo1383getSupertypes = mo1382getDeclarationDescriptor().getUnderlyingType().getConstructor().mo1383getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo1383getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
            ...
            public String toString() {
                return "[typealias " + mo1382getDeclarationDescriptor().getName().asString() + ']';
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            @NotNull
            /* renamed from: getDeclarationDescriptor */
            public TypeAliasDescriptor mo1382getDeclarationDescriptor() {
                return this.this$0;
            }
        };
    }
            ...
            */
            public final java.lang.Boolean invoke(kotlin.reflect.jvm.internal.impl.types.UnwrappedType r5) {
                /*
                    ...
                    kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r5 = r5.mo1382getDeclarationDescriptor()
                ...
                L2e:
                    ...
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor.C04431.invoke(kotlin.reflect.jvm.internal.impl.types.UnwrappedType):java.lang.Boolean");
            }
        });
    }
