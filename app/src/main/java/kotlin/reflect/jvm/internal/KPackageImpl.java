            ...
            this.multifileFacade = ReflectProperties.lazy(new Function0<Class<?>>() { // from class: kotlin.reflect.jvm.internal.KPackageImpl$Data$multifileFacade$2
                ...
                public final Class<?> invoke() {
                    ...
                    if (multifileClassName.length() > 0) {
                        return kPackageImpl.getJClass().getClassLoader().loadClass(StringsKt__StringsJVMKt.replace$default(multifileClassName, IOUtils.DIR_SEPARATOR_UNIX, FilenameUtils.EXTENSION_SEPARATOR, false, 4, (Object) null));
                    }
                    return null;
                }
            });
