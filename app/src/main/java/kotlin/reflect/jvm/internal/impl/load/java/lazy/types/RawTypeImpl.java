...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor classifierDescriptorMo1382getDeclarationDescriptor = getConstructor().mo1382getDeclarationDescriptor();
        ...
        throw new IllegalStateException(("Incorrect classifier: " + getConstructor().mo1382getDeclarationDescriptor()).toString());
    }
    ...
    public String render(@NotNull DescriptorRenderer renderer, @NotNull DescriptorRendererOptions options) {
        ...
        List listZip = CollectionsKt___CollectionsKt.zip(listRender$renderArguments, listRender$renderArguments2);
        boolean z = true;
