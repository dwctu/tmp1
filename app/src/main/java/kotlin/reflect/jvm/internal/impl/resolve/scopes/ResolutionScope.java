...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo1384getContributedClassifier(@NotNull Name name, @NotNull LookupLocation lookupLocation);
    ...
    void mo1393recordLookup(@NotNull Name name, @NotNull LookupLocation lookupLocation);
}
