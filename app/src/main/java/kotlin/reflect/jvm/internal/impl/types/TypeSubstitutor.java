...
public class TypeSubstitutor {
    ...
    */
    ...
    private TypeProjection substituteCompoundType(TypeProjection typeProjection, int i) throws SubstitutionException {
        ...
        if (type.getConstructor().mo1382getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return typeProjection;
        }
    ...
    private TypeProjection unsafeSubstitute(@NotNull TypeProjection typeProjection, @Nullable TypeParameterDescriptor typeParameterDescriptor, int i) throws SubstitutionException {
        ...
        TypeProjection typeProjectionMo1391get = this.substitution.mo1391get(type);
        TypeProjection typeProjectionProjectedTypeForConflictedTypeWithUnsafeVariance = typeProjectionMo1391get != null ? projectedTypeForConflictedTypeWithUnsafeVariance(type, typeProjectionMo1391get, typeParameterDescriptor, typeProjection) : null;
        Variance projectionKind = typeProjection.getProjectionKind();
