...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
            ...
            public final DescriptorRendererImpl invoke() {
                DescriptorRenderer descriptorRendererWithOptions = this.this$0.withOptions(new Function1<DescriptorRendererOptions, Unit>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$functionTypeAnnotationsRenderer$2.1
                    ...
                    public final void invoke2(@NotNull DescriptorRendererOptions withOptions) {
                        ...
                        withOptions.setExcludedTypeAnnotationClasses(SetsKt___SetsKt.plus((Set) withOptions.getExcludedTypeAnnotationClasses(), (Iterable) CollectionsKt__CollectionsKt.listOf((Object[]) new FqName[]{StandardNames.FqNames.extensionFunctionType, StandardNames.FqNames.contextFunctionTypeParams})));
                    }
                });
    ...
    */
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo1375getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo1375getUnsubstitutedPrimaryConstructor = annotationClass.mo1375getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo1375getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
        ...
        ArrayList arrayList5 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(setEntrySet, 10));
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) throws IOException {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo1375getUnsubstitutedPrimaryConstructor = classDescriptor.mo1375getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, classConstructorDescriptorMo1375getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo1375getUnsubstitutedPrimaryConstructor.getVisibility();
            ...
            renderValueParameters(valueParameters, classConstructorDescriptorMo1375getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo1377getCompileTimeInitializer;
        if (!getIncludePropertyConstant() || (constantValueMo1377getCompileTimeInitializer = variableDescriptor.mo1377getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(constantValueMo1377getCompileTimeInitializer)));
    }
    ...
    */
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(collectionMo1383getSupertypes, "klass.typeConstructor.supertypes");
        if (collectionMo1383getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo1383getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo1383getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt___CollectionsKt.joinTo$default(collectionMo1383getSupertypes, sb, ", ", null, null, 0, null, new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderSuperTypes.1
            {
                super(1);
            }
    ...
    */
    ...
    public String renderAnnotation(@NotNull AnnotationDescriptor annotation, @Nullable AnnotationUseSiteTarget annotationUseSiteTarget) throws IOException {
        ...
        if (getIncludeAnnotationArguments()) {
            ...
            if (getIncludeEmptyAnnotationArguments() || (!listRenderAndSortAnnotationArguments.isEmpty())) {
                CollectionsKt___CollectionsKt.joinTo$default(listRenderAndSortAnnotationArguments, sb, ", ", "(", ")", 0, null, null, 112, null);
            }
        }
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1382getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    public String renderTypeConstructor(@NotNull TypeConstructor typeConstructor) {
        ...
        if (classifierDescriptorMo1382getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : classifierDescriptorMo1382getDeclarationDescriptor instanceof ClassDescriptor ? true : classifierDescriptorMo1382getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(classifierDescriptorMo1382getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo1382getDeclarationDescriptor.getClass()).toString());
    }
