...
public final class KTypeImpl$arguments$2 extends Lambda implements Function0<List<? extends KTypeProjection>> {
    ...
    public static final List<Type> m1368invoke$lambda0(Lazy<? extends List<? extends Type>> lazy) {
    ...
    public final List<? extends KTypeProjection> invoke() {
        ...
        final Lazy lazy = LazyKt__LazyJVMKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<List<? extends Type>>() { // from class: kotlin.reflect.jvm.internal.KTypeImpl$arguments$2$parameterizedTypeArguments$2
            {
                super(0);
            }
            ...
            if (typeProjection.isStarProjection()) {
                ...
                KTypeImpl kTypeImpl3 = new KTypeImpl(type, function0 == null ? null : new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KTypeImpl$arguments$2$1$type$1
                    ...
                    public final Type invoke() {
                        ...
                        Type type2 = (Type) KTypeImpl$arguments$2.m1368invoke$lambda0(lazy).get(i);
