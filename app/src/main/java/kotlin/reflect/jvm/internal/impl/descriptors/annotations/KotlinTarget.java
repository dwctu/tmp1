...
public final class KotlinTarget {
    ...
    static {
        ...
        FIELD = new KotlinTarget("FIELD", 4, FormField.ELEMENT, z2, i2, defaultConstructorMarker2);
        ...
        OBJECT_LIST = CollectionsKt__CollectionsKt.listOf((Object[]) new KotlinTarget[]{kotlinTarget4, kotlinTarget3});
