...
public final class ProtoBuf {
            ...
            while (true) {
                ...
                if (!z) {
                    try {
                        ...
                        if ((i & unknownField) == unknownField) {
                            this.versionRequirement_ = Collections.unmodifiableList(this.versionRequirement_);
                        }
                        try {
                            codedOutputStreamNewInstance.flush();
                ...
                try {
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 8) {
                                int i2 = codedInputStream.readEnum();
                                EffectType effectTypeValueOf = EffectType.valueOf(i2);
                                ...
                                InvocationKind invocationKindValueOf = InvocationKind.valueOf(i3);
    ...
    public static final class EnumEntry extends GeneratedMessageLite.ExtendableMessage<EnumEntry> implements EnumEntryOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            int iComputeInt32Size = ((this.bitField0_ & 1) == 1 ? 0 + CodedOutputStream.computeInt32Size(1, this.name_) : 0) + extensionsSerializedSize() + this.unknownFields.size();
