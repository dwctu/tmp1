...
public final class MethodSignatureMappingKt {
    ...
    public static final boolean forceSingleValueParameterBoxing(@NotNull CallableDescriptor f) {
        ...
        if (!Intrinsics.areEqual(functionDescriptor.getName().asString(), DiscoverItems.Item.REMOVE_ACTION) || functionDescriptor.getValueParameters().size() != 1 || SpecialBuiltinMembers.isFromJavaOrBuiltins((CallableMemberDescriptor) f)) {
            return false;
        }
