...
public final class FlexibleTypeImpl extends FlexibleType implements CustomTypeParameter {
    ...
    public boolean isTypeParameter() {
        return (getLowerBound().getConstructor().mo1382getDeclarationDescriptor() instanceof TypeParameterDescriptor) && Intrinsics.areEqual(getLowerBound().getConstructor(), getUpperBound().getConstructor());
    }
