...
public final class JavaAnnotationTargetMapper {
    ...
    @NotNull
    private static final Map<String, KotlinRetention> retentionNameList = MapsKt__MapsKt.mapOf(TuplesKt.to("RUNTIME", KotlinRetention.RUNTIME), TuplesKt.to("CLASS", KotlinRetention.BINARY), TuplesKt.to(BleService.EXTRA_SOURCE, KotlinRetention.SOURCE));
