...
public final class OperatorNameConventions {
    ...
    static {
        ...
        Name nameIdentifier11 = Name.identifier(RSMSet.ELEMENT);
        ...
        Intrinsics.checkNotNullExpressionValue(nameIdentifier34, "identifier(\"timesAssign\")");
        TIMES_ASSIGN = nameIdentifier34;
        Name nameIdentifier35 = Name.identifier("divAssign");
        Intrinsics.checkNotNullExpressionValue(nameIdentifier35, "identifier(\"divAssign\")");
        DIV_ASSIGN = nameIdentifier35;
        Name nameIdentifier36 = Name.identifier("modAssign");
        Intrinsics.checkNotNullExpressionValue(nameIdentifier36, "identifier(\"modAssign\")");
        MOD_ASSIGN = nameIdentifier36;
        Name nameIdentifier37 = Name.identifier("remAssign");
        Intrinsics.checkNotNullExpressionValue(nameIdentifier37, "identifier(\"remAssign\")");
        REM_ASSIGN = nameIdentifier37;
        Name nameIdentifier38 = Name.identifier("plusAssign");
        Intrinsics.checkNotNullExpressionValue(nameIdentifier38, "identifier(\"plusAssign\")");
        PLUS_ASSIGN = nameIdentifier38;
        Name nameIdentifier39 = Name.identifier("minusAssign");
        Intrinsics.checkNotNullExpressionValue(nameIdentifier39, "identifier(\"minusAssign\")");
        MINUS_ASSIGN = nameIdentifier39;
        UNARY_OPERATION_NAMES = SetsKt__SetsKt.setOf((Object[]) new Name[]{nameIdentifier22, nameIdentifier23, nameIdentifier28, nameIdentifier27, nameIdentifier26, nameIdentifier18});
        SIMPLE_UNARY_OPERATION_NAMES = SetsKt__SetsKt.setOf((Object[]) new Name[]{nameIdentifier28, nameIdentifier27, nameIdentifier26, nameIdentifier18});
        BINARY_OPERATION_NAMES = SetsKt__SetsKt.setOf((Object[]) new Name[]{nameIdentifier29, nameIdentifier24, nameIdentifier25, nameIdentifier30, nameIdentifier31, nameIdentifier32, nameIdentifier33});
        ASSIGNMENT_OPERATIONS = SetsKt__SetsKt.setOf((Object[]) new Name[]{nameIdentifier34, nameIdentifier35, nameIdentifier36, nameIdentifier37, nameIdentifier38, nameIdentifier39});
        DELEGATED_PROPERTY_OPERATORS = SetsKt__SetsKt.setOf((Object[]) new Name[]{nameIdentifier, nameIdentifier2, nameIdentifier3});
    }
