    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo1383getSupertypes = capturedTypeConstructorImpl.mo1383getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo1383getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1383getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo1383getSupertypes2, 10));
            Iterator<T> it2 = collectionMo1383getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo1383getSupertypes3 = intersectionTypeConstructor.mo1383getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo1383getSupertypes3, 10));
        Iterator<T> it3 = collectionMo1383getSupertypes3.iterator();
        while (it3.hasNext()) {
