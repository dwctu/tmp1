    ...
    public final KClassifier convert(KotlinType type) {
        ...
        if (!(classifierDescriptorMo1382getDeclarationDescriptor instanceof ClassDescriptor)) {
            if (classifierDescriptorMo1382getDeclarationDescriptor instanceof TypeParameterDescriptor) {
                return new KTypeParameterImpl(null, (TypeParameterDescriptor) classifierDescriptorMo1382getDeclarationDescriptor);
            }
        ...
        Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo1382getDeclarationDescriptor);
        if (javaClass == null) {
            return null;
        }
