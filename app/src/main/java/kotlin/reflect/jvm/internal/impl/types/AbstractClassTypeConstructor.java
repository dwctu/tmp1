...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor implements TypeConstructor {
    ...
    */
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo1382getDeclarationDescriptor())) {
            return null;
        }
    ...
    public Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo1382getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo1374getCompanionObjectDescriptor = classDescriptor.mo1374getCompanionObjectDescriptor();
        if (z && classDescriptorMo1374getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo1374getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo1382getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo1382getDeclarationDescriptor();
    ...
    public boolean isSameClassifier(@NotNull ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo1382getDeclarationDescriptor(), classifierDescriptor);
    }
}
