...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(@NotNull KotlinType type) {
        ClassifierDescriptor classifierDescriptorMo1382getDeclarationDescriptor;
        Intrinsics.checkNotNullParameter(type, "type");
        if (TypeUtils.noExpectedType(type) || (classifierDescriptorMo1382getDeclarationDescriptor = type.getConstructor().mo1382getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(classifierDescriptorMo1382getDeclarationDescriptor);
    }
