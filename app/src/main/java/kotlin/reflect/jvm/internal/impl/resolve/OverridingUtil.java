...
public class OverridingUtil {
    ...
    public static class OverrideCompatibilityInfo {
        private static final OverrideCompatibilityInfo SUCCESS = new OverrideCompatibilityInfo(Result.OVERRIDABLE, MonitorResult.SUCCESS);
    ...
    */
    ...
    private static Collection<CallableMemberDescriptor> filterVisibleFakeOverrides(@NotNull final ClassDescriptor classDescriptor, @NotNull Collection<CallableMemberDescriptor> collection) {
        ...
        List listFilter = CollectionsKt___CollectionsKt.filter(collection, new Function1<CallableMemberDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.5
            @Override // kotlin.jvm.functions.Function1
            public Boolean invoke(CallableMemberDescriptor callableMemberDescriptor) {
                boolean z = false;
    ...
    public static <H> H selectMostSpecificMember(@NotNull Collection<H> collection, @NotNull Function1<H, CallableDescriptor> function1) {
        ...
        if (arrayList.size() == 1) {
            H h4 = (H) CollectionsKt___CollectionsKt.first((Iterable) arrayList);
            if (h4 == null) {
                $$$reportNull$$$0(82);
            }
            return h4;
        ...
        H h6 = (H) CollectionsKt___CollectionsKt.first((Iterable) arrayList);
        if (h6 == null) {
            $$$reportNull$$$0(84);
        }
        return h6;
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2, boolean z) {
        ...
        for (int i3 = 0; i3 < listCompiledValueParameters.size(); i3++) {
            if (!areTypesEquivalent(listCompiledValueParameters.get(i3), listCompiledValueParameters2.get(i3), typeCheckerStateCreateTypeCheckerState)) {
        ...
        if (z) {
            ...
            if (returnType != null && returnType2 != null) {
                ...
                if (i == 0 && !AbstractTypeChecker.INSTANCE.isSubtypeOf(typeCheckerStateCreateTypeCheckerState, returnType2.unwrap(), returnType.unwrap())) {
