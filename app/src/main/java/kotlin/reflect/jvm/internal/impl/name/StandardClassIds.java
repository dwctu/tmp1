...
public final class StandardClassIds {
    ...
    static {
        ...
        constantAllowedTypes = SetsKt___SetsKt.plus((Set<? extends ClassId>) SetsKt___SetsKt.plus((Set) primitiveTypes, (Iterable) unsignedTypes), String);
        ...
        Result = StandardClassIdsKt.baseId(GameActivity.DOWNLOAD_RETURN_NAME);
