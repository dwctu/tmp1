...
public class KProperty1Impl<T, V> extends KPropertyImpl<V> implements KProperty1<T, V> {
    ...
    public KProperty1Impl(@NotNull KDeclarationContainerImpl container, @NotNull String name, @NotNull String signature, @Nullable Object obj) {
        ...
        ReflectProperties.LazyVal<Getter<T, V>> lazyValLazy = ReflectProperties.lazy(new Function0<Getter<T, ? extends V>>(this) { // from class: kotlin.reflect.jvm.internal.KProperty1Impl$_getter$1
        ...
        this.delegateSource = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<Member>(this) { // from class: kotlin.reflect.jvm.internal.KProperty1Impl$delegateSource$1
            public final /* synthetic */ KProperty1Impl<T, V> this$0;
