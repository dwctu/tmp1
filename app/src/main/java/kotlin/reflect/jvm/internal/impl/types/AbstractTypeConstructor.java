...
public abstract class AbstractTypeConstructor extends ClassifierBasedTypeConstructor {
    ...
    public final class ModuleViewTypeConstructor implements TypeConstructor {
        ...
        public ModuleViewTypeConstructor(@NotNull final AbstractTypeConstructor abstractTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
            ...
            this.refinedSupertypes$delegate = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<List<? extends KotlinType>>() { // from class: kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor$ModuleViewTypeConstructor$refinedSupertypes$2
                ...
                public final List<? extends KotlinType> invoke() {
                    return KotlinTypeRefinerKt.refineTypes(this.this$0.kotlinTypeRefiner, abstractTypeConstructor.mo1383getSupertypes());
                }
            });
        }
        ...
        public ClassifierDescriptor mo1382getDeclarationDescriptor() {
            return this.this$0.mo1382getDeclarationDescriptor();
        }
        ...
        public List<KotlinType> mo1383getSupertypes() {
        ...
        this.supertypes = storageManager.createLazyValueWithPostCompute(new Function0<Supertypes>() { // from class: kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor$supertypes$1
            ...
            public final void invoke2(@NotNull AbstractTypeConstructor.Supertypes supertypes) {
                ...
                if (collectionFindLoopsInSupertypesAndDisconnect.isEmpty()) {
                    ...
                    collectionFindLoopsInSupertypesAndDisconnect = kotlinTypeDefaultSupertypeIfEmpty != null ? CollectionsKt__CollectionsJVMKt.listOf(kotlinTypeDefaultSupertypeIfEmpty) : null;
                    if (collectionFindLoopsInSupertypesAndDisconnect == null) {
                        collectionFindLoopsInSupertypesAndDisconnect = CollectionsKt__CollectionsKt.emptyList();
                    }
                }
                ...
                if (list == null) {
                    list = CollectionsKt___CollectionsKt.toList(collectionFindLoopsInSupertypesAndDisconnect);
                }
    ...
    public final Collection<KotlinType> computeNeighbours(TypeConstructor typeConstructor, boolean z) {
        ...
        if (abstractTypeConstructor != null && (listPlus = CollectionsKt___CollectionsKt.plus((Collection) abstractTypeConstructor.supertypes.invoke().getAllSupertypes(), (Iterable) abstractTypeConstructor.getAdditionalNeighboursInSupertypeGraph(z))) != null) {
            return listPlus;
        }
        Collection<KotlinType> supertypes = typeConstructor.mo1383getSupertypes();
