...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1384getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo1384getContributedClassifier = this.javaScope.mo1384getContributedClassifier(name, location);
        if (classDescriptorMo1384getContributedClassifier != null) {
            return classDescriptorMo1384getContributedClassifier;
        }
