...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            ...
            INSTANCE.addKotlinToJava(new FqName((functionClassKind5.getPackageFqName().toString() + FilenameUtils.EXTENSION_SEPARATOR + functionClassKind5.getClassNamePrefix()) + i2), K_FUNCTION_CLASS_ID);
        }
    ...
    private final boolean isKotlinFunctionWithBigArity(FqNameUnsafe fqNameUnsafe, String str) {
        ...
        return (strSubstringAfter.length() > 0) && !StringsKt__StringsKt.startsWith$default((CharSequence) strSubstringAfter, '0', false, 2, (Object) null) && (intOrNull = StringsKt__StringNumberConversionsKt.toIntOrNull(strSubstringAfter)) != null && intOrNull.intValue() >= 23;
    }
