...
public abstract class InternalUnderlyingValOfInlineClass implements Caller<Method> {
    ...
    public static final class Unbound extends InternalUnderlyingValOfInlineClass {
        ...
        public Object call(@NotNull Object[] args) {
            ...
            if (args.length <= 1) {
                ...
                objArrCopyOfRange = ArraysKt___ArraysJvmKt.copyOfRange(args, 1, args.length);
                Intrinsics.checkNotNull(objArrCopyOfRange, "null cannot be cast to non-null type kotlin.Array<T of kotlin.reflect.jvm.internal.calls.CallerImpl.Companion.dropFirst>");
            }
    ...
    public final Method mo1369getMember() {
        return null;
    }
