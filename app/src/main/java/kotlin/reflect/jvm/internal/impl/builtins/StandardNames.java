...
public final class StandardNames {
    ...
    public static final class FqNames {
        ...
        static {
            ...
            FqName fqNameCollectionsFqName2 = fqNames2.collectionsFqName("MutableMap");
            ...
            for (PrimitiveType primitiveType3 : PrimitiveType.values()) {
                ...
                mapNewHashMapWithExpectedSize.put(fqNames3.fqNameUnsafe(strAsString), primitiveType3);
            }
            ...
            for (PrimitiveType primitiveType4 : PrimitiveType.values()) {
                ...
                mapNewHashMapWithExpectedSize2.put(fqNames4.fqNameUnsafe(strAsString2), primitiveType4);
            }
    ...
    static {
        Name nameIdentifier = Name.identifier(FormField.ELEMENT);
        ...
        Name nameIdentifier7 = Name.identifier(XHTMLText.CODE);
