...
public final class ParameterizedTypeImpl implements ParameterizedType, TypeImpl {
    ...
    public String getTypeName() throws IOException {
        ...
        if (!(typeArr.length == 0)) {
            ArraysKt___ArraysKt.joinTo(typeArr, sb, (50 & 2) != 0 ? ", " : null, (50 & 4) != 0 ? "" : SimpleComparison.LESS_THAN_OPERATION, (50 & 8) == 0 ? SimpleComparison.GREATER_THAN_OPERATION : "", (50 & 16) != 0 ? -1 : 0, (50 & 32) != 0 ? "..." : null, (50 & 64) != 0 ? null : ParameterizedTypeImpl$getTypeName$1$1.INSTANCE);
        }
