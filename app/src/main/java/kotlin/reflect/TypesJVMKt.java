...
public final class TypesJVMKt {
    ...
    public static final String typeToString(Type type) {
        ...
        if (cls.isArray()) {
            ...
            name = ((Class) SequencesKt___SequencesKt.last(sequenceGenerateSequence)).getName() + StringsKt__StringsJVMKt.repeat("[]", SequencesKt___SequencesKt.count(sequenceGenerateSequence));
        } else {
            name = cls.getName();
        }
