...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
            ...
            if (!jClass.isAnonymousClass()) {
                if (jClass.isLocalClass()) {
                    ...
                    if (enclosingMethod != null) {
                        ...
                        String strSubstringAfter$default = StringsKt__StringsKt.substringAfter$default(name, enclosingMethod.getName() + Typography.dollar, (String) null, 2, (Object) null);
    ...
    static {
        ...
        for (String kotlinName : collectionValues) {
            ...
            sb.append(StringsKt__StringsKt.substringAfterLast$default(kotlinName, FilenameUtils.EXTENSION_SEPARATOR, (String) null, 2, (Object) null));
        ...
        for (Map.Entry entry2 : map3.entrySet()) {
            linkedHashMap.put(entry2.getKey(), StringsKt__StringsKt.substringAfterLast$default((String) entry2.getValue(), FilenameUtils.EXTENSION_SEPARATOR, (String) null, 2, (Object) null));
        }
