...
public final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    public final RingBuffer<T> expanded(int maxCapacity) {
        Object[] array;
        int i = this.capacity;
        int iCoerceAtMost = RangesKt___RangesKt.coerceAtMost(i + (i >> 1) + 1, maxCapacity);
