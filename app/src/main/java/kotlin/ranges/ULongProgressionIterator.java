...
public final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        this.hasNext = z;
        this.step = ULong.m260constructorimpl(j3);
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m254boximpl(m1331nextsVKNKU());
    }

    /* renamed from: next-s-VKNKU, reason: not valid java name */
    public long m1331nextsVKNKU() {
        long j = this.next;
        if (j != this.finalElement) {
            this.next = ULong.m260constructorimpl(this.step + j);
        } else {
            if (!this.hasNext) {
