...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1321fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1305getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m227toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) UInt.m227toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
