...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1330fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1304getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM260constructorimpl = ((int) ULong.m260constructorimpl(j ^ ULong.m260constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM260constructorimpl2 = (iM260constructorimpl + ((int) ULong.m260constructorimpl(j2 ^ ULong.m260constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM260constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m306toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m306toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
