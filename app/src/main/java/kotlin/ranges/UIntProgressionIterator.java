...
public final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m181constructorimpl(i3);
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m175boximpl(m1322nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA, reason: not valid java name */
    public int m1322nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m181constructorimpl(this.step + i);
        } else {
            if (!this.hasNext) {
