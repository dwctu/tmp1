...
public class ExceptionsKt__ExceptionsKt {
    ...
    @HidesMembers
    public static final void addSuppressed(@NotNull Throwable th, @NotNull Throwable exception) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
