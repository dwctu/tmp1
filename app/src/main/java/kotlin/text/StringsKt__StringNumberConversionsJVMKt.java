...
public class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    ...
    private static final String toString(byte b, int i) {
        String string = Integer.toString(b, CharsKt__CharJVMKt.checkRadix(CharsKt__CharJVMKt.checkRadix(i)));
    ...
    private static final String toString(short s, int i) {
        String string = Integer.toString(s, CharsKt__CharJVMKt.checkRadix(CharsKt__CharJVMKt.checkRadix(i)));
        Intrinsics.checkNotNullExpressionValue(string, "toString(this, checkRadix(radix))");
        return string;
    }
