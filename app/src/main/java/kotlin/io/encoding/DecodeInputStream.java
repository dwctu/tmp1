...
public final class DecodeInputStream extends InputStream {
    ...
    private final void copyByteBufferInto(byte[] dst, int dstOffset, int length) {
        ...
        ArraysKt___ArraysJvmKt.copyInto(bArr, dst, dstOffset, i, i + length);
