...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    */
    ...
    @NotNull
    public static final File copyTo(@NotNull File file, @NotNull File target, boolean z, int i) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    public static final String getExtension(@NotNull File file) {
        ...
        return StringsKt__StringsKt.substringAfterLast(name, FilenameUtils.EXTENSION_SEPARATOR, "");
    }
    ...
    public static final String getInvariantSeparatorsPath(@NotNull File file) {
        ...
        if (File.separatorChar != '/') {
            ...
            return StringsKt__StringsJVMKt.replace$default(path, File.separatorChar, IOUtils.DIR_SEPARATOR_UNIX, false, 4, (Object) null);
        }
    ...
    public static final File resolve(@NotNull File file, @NotNull File relative) {
        ...
        if ((string.length() == 0) || StringsKt__StringsKt.endsWith$default((CharSequence) string, File.separatorChar, false, 2, (Object) null)) {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) throws IOException {
        ...
        if (i < size2) {
            ...
            List listDrop = CollectionsKt___CollectionsKt.drop(filePathComponentsNormalize$FilesKt__UtilsKt.getSegments(), i);
            String separator = File.separator;
            Intrinsics.checkNotNullExpressionValue(separator, "separator");
