...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public final long m1567adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1579constructorimpl(LongSaturatedMathKt.m1565saturatingAddpTJri5U(timeMark, duration));
    }

    /* renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m1568differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another);
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1569elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    @Override // kotlin.time.TimeSource.WithComparableMarks, kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1576boximpl(m1570markNowz9LOYto());
    }

    /* renamed from: markNow-z9LOYto, reason: not valid java name */
    public long m1570markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1579constructorimpl(read());
    }
