...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1426elapsedNowUwyO8pc() {
            return Duration.m1472minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(@Nullable Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1442equalsimpl0(mo1428minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1539getZEROUwyO8pc());
        }
        ...
        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1465hashCodeimpl(Duration.m1473plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }
        ...
        public long mo1428minusUwyO8pc(@NotNull ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1442equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1469isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m1539getZEROUwyO8pc();
                    }
                    long jM1472minusLRDsOJo = Duration.m1472minusLRDsOJo(this.offset, doubleTimeMark.offset);
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt__DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1486toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
        ...
        public ComparableTimeMark mo1429plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1473plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1539getZEROUwyO8pc(), null);
    }
}
