...
public final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1426elapsedNowUwyO8pc() {
        return Duration.m1472minusLRDsOJo(this.mark.mo1426elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark mo1427minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1573minusLRDsOJo(this, j);
    }
    ...
    public TimeMark mo1429plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1473plusLRDsOJo(this.adjustment, duration), null);
    }
}
