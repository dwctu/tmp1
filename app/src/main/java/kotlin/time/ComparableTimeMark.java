...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(@NotNull ComparableTimeMark comparableTimeMark, @NotNull ComparableTimeMark other) {
            ...
            return Duration.m1436compareToLRDsOJo(comparableTimeMark.mo1428minusUwyO8pc(other), Duration.INSTANCE.m1539getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m1432minusLRDsOJo(@NotNull ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1429plusLRDsOJo(Duration.m1489unaryMinusUwyO8pc(j));
        }
    }
    ...
    ComparableTimeMark mo1427minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1428minusUwyO8pc(@NotNull ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    @NotNull
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1429plusLRDsOJo(long duration);
}
