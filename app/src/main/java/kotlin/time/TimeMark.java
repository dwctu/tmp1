...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        public static boolean hasNotPassedNow(@NotNull TimeMark timeMark) {
            return Duration.m1470isNegativeimpl(timeMark.mo1426elapsedNowUwyO8pc());
        }
        ...
        public static TimeMark m1573minusLRDsOJo(@NotNull TimeMark timeMark, long j) {
            return timeMark.mo1429plusLRDsOJo(Duration.m1489unaryMinusUwyO8pc(j));
        }

        @NotNull
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1574plusLRDsOJo(@NotNull TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }
    }

    /* renamed from: elapsedNow-UwyO8pc */
    long mo1426elapsedNowUwyO8pc();
    ...
    TimeMark mo1427minusLRDsOJo(long duration);

    @NotNull
    /* renamed from: plus-LRDsOJo */
    TimeMark mo1429plusLRDsOJo(long duration);
}
