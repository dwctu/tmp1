...
public abstract class ContinuationImpl extends BaseContinuationImpl {
    ...
    public final Continuation<Object> intercepted() {
        ...
        if (continuationInterceptContinuation == null) {
            ContinuationInterceptor continuationInterceptor = (ContinuationInterceptor) getB().get(ContinuationInterceptor.INSTANCE);
    ...
    public void releaseIntercepted() {
        ...
        if (continuation != null && continuation != this) {
            CoroutineContext.Element element = getB().get(ContinuationInterceptor.INSTANCE);
    ...
    public ContinuationImpl(@Nullable Continuation<Object> continuation) {
        this(continuation, continuation != null ? continuation.getB() : null);
    }
}
