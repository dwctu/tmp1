...
public final class KotlinExtensions {
    ...
    /* compiled from: KotlinExtensions.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0001\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u0005*\u00060\u0000j\u0002`\u00012\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002H\u0080@¢\u0006\u0004\b\u0006\u0010\u0007"}, d2 = {"Ljava/lang/Exception;", "Lkotlin/Exception;", "Lkotlin/coroutines/Continuation;", "", "continuation", "", "suspendAndThrow", "(Ljava/lang/Exception;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 4, 0})
    ...
    public static final <T> Object await(@NotNull final Call<T> call, @NotNull Continuation<? super T> continuation) {
        ...
        zy3Var.f(new Function1<Throwable, Unit>() { // from class: retrofit2.KotlinExtensions$await$$inlined$suspendCancellableCoroutine$lambda$1
            {
                super(1);
            }
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$2$2
            ...
            public void onFailure(@NotNull Call<T> call2, @NotNull Throwable t) {
                ...
                yy3Var.resumeWith(Result.m86constructorimpl(ResultKt.createFailure(t)));
            }
            ...
            public void onResponse(@NotNull Call<T> call2, @NotNull Response<T> response) {
                ...
                if (!response.isSuccessful()) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    yy3Var.resumeWith(Result.m86constructorimpl(ResultKt.createFailure(httpException)));
                    return;
                }
                ...
                if (tBody != null) {
                    ...
                    yy3Var2.resumeWith(Result.m86constructorimpl(tBody));
                    return;
                }
                Object objI = call2.request().i(Invocation.class);
                if (objI == null) {
                    Intrinsics.throwNpe();
                }
                Intrinsics.checkExpressionValueIsNotNull(objI, "call.request().tag(Invocation::class.java)!!");
                Method method = ((Invocation) objI).method();
                ...
                yy3Var3.resumeWith(Result.m86constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
            }
        });
    ...
    public static final <T> Object awaitNullable(@NotNull final Call<T> call, @NotNull Continuation<? super T> continuation) {
        final zy3 zy3Var = new zy3(IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation), 1);
        zy3Var.f(new Function1<Throwable, Unit>() { // from class: retrofit2.KotlinExtensions$await$$inlined$suspendCancellableCoroutine$lambda$2
            {
                super(1);
            }
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$4$2
            ...
            public void onResponse(@NotNull Call<T> call2, @NotNull Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    T tBody = response.body();
                    Result.Companion companion = Result.INSTANCE;
                    yy3Var.resumeWith(Result.m86constructorimpl(tBody));
                    return;
                }
                yy3 yy3Var2 = zy3Var;
                HttpException httpException = new HttpException(response);
                Result.Companion companion2 = Result.INSTANCE;
                yy3Var2.resumeWith(Result.m86constructorimpl(ResultKt.createFailure(httpException)));
            }
        });
        Object objX = zy3Var.x();
        if (objX == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final <T> Object awaitResponse(@NotNull final Call<T> call, @NotNull Continuation<? super Response<T>> continuation) {
        final zy3 zy3Var = new zy3(IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation), 1);
        zy3Var.f(new Function1<Throwable, Unit>() { // from class: retrofit2.KotlinExtensions$awaitResponse$$inlined$suspendCancellableCoroutine$lambda$1
            {
                super(1);
            }
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onResponse(@NotNull Call<T> call2, @NotNull Response<T> response) {
                ...
                yy3 yy3Var = zy3Var;
                Result.Companion companion = Result.INSTANCE;
                yy3Var.resumeWith(Result.m86constructorimpl(response));
            }
        });
        Object objX = zy3Var.x();
        if (objX == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
