...
public class JUnit4ClassRunner extends Runner implements Filterable, Sortable {
    ...
    public void invokeTestMethod(Method method, RunNotifier runNotifier) throws StoppedByUserException {
    ...
    public void runMethods(RunNotifier runNotifier) throws StoppedByUserException {
        Iterator<Method> it = this.testMethods.iterator();
        while (it.hasNext()) {
