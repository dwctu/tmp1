    ...
    public void runTestMethod() {
        try {
            ...
            if (this.testMethod.isUnexpected(targetException)) {
                addFailure(new Exception("Unexpected exception, expected<" + this.testMethod.getExpectedException().getName() + "> but was<" + targetException.getClass().getName() + SimpleComparison.GREATER_THAN_OPERATION, targetException));
            }
        } catch (Throwable th) {
            addFailure(th);
        }
