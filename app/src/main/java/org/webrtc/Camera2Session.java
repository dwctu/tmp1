...
public class Camera2Session implements CameraSession {
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public /* synthetic */ void b(VideoFrame videoFrame) {
            ...
            VideoFrame videoFrame2 = new VideoFrame(jg4.a((TextureBufferImpl) videoFrame.getBuffer(), Camera2Session.this.isCameraFrontFacing, -Camera2Session.this.cameraOrientation), Camera2Session.this.getFrameOrientation(), videoFrame.getTimestampNs());
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) throws CameraAccessException {
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: dc.ff4
