...
public class EncodedImage implements RefCounted {
    ...
    @CalledByNative
    private EncodedImage(ByteBuffer byteBuffer, boolean z, @Nullable Runnable runnable, int i, int i2, long j, FrameType frameType, int i3, boolean z2, @Nullable Integer num) {
        this.buffer = byteBuffer;
        this.encodedWidth = i;
