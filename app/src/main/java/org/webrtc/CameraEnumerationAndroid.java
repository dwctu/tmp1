    ...
    public static class CaptureFormat {
        ...
        public static class FramerateRange {
            ...
            public String toString() {
                return "[" + (this.min / 1000.0f) + SignatureImpl.INNER_SEP + (this.max / 1000.0f) + "]";
            }
        }
