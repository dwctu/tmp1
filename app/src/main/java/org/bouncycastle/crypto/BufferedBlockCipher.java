...
public class BufferedBlockCipher {
    ...
    public BufferedBlockCipher(BlockCipher blockCipher) {
        ...
        if (iIndexOf > 0 && (algorithmName.startsWith("CFB", iIndexOf) || algorithmName.startsWith("GCFB", iIndexOf) || algorithmName.startsWith("OFB", iIndexOf) || algorithmName.startsWith("OpenPGP", iIndexOf) || algorithmName.startsWith("SIC", iIndexOf) || algorithmName.startsWith("GCTR", iIndexOf))) {
            z = true;
        }
