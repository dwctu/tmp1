...
public class SkeinEngine implements Memoable {
    ...
    public static class UbiTweak {
        ...
        public void advancePosition(int i) {
            ...
            jArr4[1] = (jArr2[2] & UnsignedInts.INT_MASK) | (jArr4[1] & (-4294967296L));
        }
    ...
    static {
        ...
        initialState(512, Function.USE_VARARGS, new long[]{-6631894876634615969L, -5692838220127733084L, -7099962856338682626L, -2911352911530754598L, 2000907093792408677L, 9140007292425499655L, 6093301768906360022L, 2769176472213098488L});
