...
public class SerpentEngine implements BlockCipher {
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int iBytesToWord = bytesToWord(bArr, i + 12) ^ this.wKey[128];
        this.X0 = iBytesToWord;
        ib7(iBytesToWord, this.X1, this.X2, this.X3);
        int i3 = this.X0;
        int[] iArr = this.wKey;
        this.X0 = i3 ^ iArr[124];
        this.X1 ^= iArr[125];
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int iBytesToWord = bytesToWord(bArr, i + 12);
        this.X0 = iBytesToWord;
        int[] iArr = this.wKey;
        sb0(iBytesToWord ^ iArr[0], iArr[1] ^ this.X1, iArr[2] ^ this.X2, iArr[3] ^ this.X3);
        LT();
        int[] iArr2 = this.wKey;
