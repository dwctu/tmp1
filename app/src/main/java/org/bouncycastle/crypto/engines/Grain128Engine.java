...
public class Grain128Engine implements StreamCipher {
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            int i4 = i2 + 2;
            int i5 = i2 + 1;
            iArr[i] = (bArr3[i2] & 255) | (bArr3[i3] << Ascii.CAN) | ((bArr3[i4] << 16) & ItemTouchHelper.ACTION_MODE_DRAG_MASK) | ((bArr3[i5] << 8) & 65280);
            int[] iArr2 = this.lfsr;
            byte[] bArr4 = this.workingIV;
            iArr2[i] = (bArr4[i2] & 255) | (bArr4[i3] << Ascii.CAN) | ((bArr4[i4] << 16) & ItemTouchHelper.ACTION_MODE_DRAG_MASK) | ((bArr4[i5] << 8) & 65280);
            i2 += 4;
            i++;
        }
    }
