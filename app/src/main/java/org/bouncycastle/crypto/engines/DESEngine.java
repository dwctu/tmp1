...
public class DESEngine implements BlockCipher {
    ...
    private static final byte[] pc1 = {56, 48, 40, 32, Ascii.CAN, 16, 8, 0, 57, 49, 41, 33, Ascii.EM, 17, 9, 1, 58, 50, ExifInterface.START_CODE, 34, Ascii.SUB, Ascii.DC2, 10, 2, 59, 51, 43, 35, 62, 54, 46, 38, Ascii.RS, Ascii.SYN, 14, 6, 61, 53, 45, URLCodec.ESCAPE_CHAR, Ascii.GS, Ascii.NAK, 13, 5, 60, 52, 44, 36, Ascii.FS, Ascii.DC4, 12, 4, Ascii.ESC, 19, 11, 3};
