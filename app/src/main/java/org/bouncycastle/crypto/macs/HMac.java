...
public class HMac implements Mac {
    ...
    static {
        ...
        blockLengths.put(MessageDigestAlgorithms.SHA_256, Integers.valueOf(64));
        blockLengths.put(MessageDigestAlgorithms.SHA_384, Integers.valueOf(128));
        blockLengths.put(MessageDigestAlgorithms.SHA_512, Integers.valueOf(128));
