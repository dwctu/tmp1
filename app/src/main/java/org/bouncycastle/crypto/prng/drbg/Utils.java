...
public class Utils {
    ...
    static {
        ...
        hashtable.put(MessageDigestAlgorithms.SHA_256, Integers.valueOf(256));
        hashtable.put(MessageDigestAlgorithms.SHA_384, Integers.valueOf(256));
        hashtable.put(MessageDigestAlgorithms.SHA_512, Integers.valueOf(256));
