    ...
    */
    public org.bouncycastle.crypto.tls.TlsCredentials getCredentials() throws java.io.IOException {
        ...
        L23:
            ...
            throw r0
        L2b:
            org.bouncycastle.crypto.tls.TlsSignerCredentials r0 = r2.getRSASignerCredentials()
            return r0
        L30:
            org.bouncycastle.crypto.tls.TlsEncryptionCredentials r0 = r2.getRSAEncryptionCredentials()
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.crypto.tls.DefaultTlsServer.getCredentials():org.bouncycastle.crypto.tls.TlsCredentials");
    }
