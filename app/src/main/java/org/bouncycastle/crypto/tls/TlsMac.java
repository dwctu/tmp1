...
public class TlsMac {
    ...
    public TlsMac(TlsContext tlsContext, Digest digest, byte[] bArr, int i, int i2) throws IllegalArgumentException {
        int i3;
    ...
    public byte[] calculateMacConstantTime(long j, short s, byte[] bArr, int i, int i2, int i3, byte[] bArr2) throws IllegalStateException, DataLengthException {
