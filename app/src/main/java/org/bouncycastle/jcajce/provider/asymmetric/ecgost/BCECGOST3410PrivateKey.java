    ...
    */
    ...
    public byte[] getEncoded() {
        ...
        if (this.gostParams != null) {
            ...
            try {
                return new PrivateKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.gostR3410_2001, (ASN1Encodable) this.gostParams), new DEROctetString(bArr)).getEncoded(ASN1Encoding.DER);
            } catch (IOException unused) {
                return null;
            }
        }
        ...
        if (eCParameterSpec instanceof ECNamedCurveSpec) {
            ...
            x962Parameters = new X962Parameters((ASN1Primitive) namedCurveOid);
        ...
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.gostR3410_2001, (ASN1Encodable) x962Parameters.toASN1Primitive()), (this.publicKey != null ? new org.bouncycastle.asn1.sec.ECPrivateKey(getS(), this.publicKey, x962Parameters) : new org.bouncycastle.asn1.sec.ECPrivateKey(getS(), x962Parameters)).toASN1Primitive()).getEncoded(ASN1Encoding.DER);
