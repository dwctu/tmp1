...
public final class DES {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm(sb2.toString(), str + "$CBC");
            ...
            configurableProvider.addAlgorithm(sb4.toString(), "PBEWITHMD5ANDDES");
            ...
            configurableProvider.addAlgorithm(sb5.toString(), "PBEWITHSHA1ANDDES");
