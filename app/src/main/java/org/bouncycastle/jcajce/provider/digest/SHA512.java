...
public class SHA512 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.MessageDigest.SHA512", MessageDigestAlgorithms.SHA_512);
            configurableProvider.addAlgorithm("Alg.Alias.MessageDigest." + NISTObjectIdentifiers.id_sha512, MessageDigestAlgorithms.SHA_512);
