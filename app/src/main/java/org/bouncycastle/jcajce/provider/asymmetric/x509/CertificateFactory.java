...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    public CRL engineGenerateCRL(InputStream inputStream) throws IOException, CRLException {
        ...
        try {
            ...
            return i != 48 ? readPEMCRL(pushbackInputStream) : readDERCRL(new ASN1InputStream((InputStream) pushbackInputStream, true));
    ...
    public Certificate engineGenerateCertificate(InputStream inputStream) throws IOException, CertificateException {
        ...
        try {
            ...
            pushbackInputStream.unread(i);
            return i != 48 ? readPEMCertificate(pushbackInputStream) : readDERCertificate(new ASN1InputStream(pushbackInputStream));
        } catch (Exception e) {
