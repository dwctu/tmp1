...
public class SHA256 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.MessageDigest.SHA256", MessageDigestAlgorithms.SHA_256);
            StringBuilder sb2 = new StringBuilder();
            sb2.append("Alg.Alias.MessageDigest.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier = NISTObjectIdentifiers.id_sha256;
            sb2.append(aSN1ObjectIdentifier);
            configurableProvider.addAlgorithm(sb2.toString(), MessageDigestAlgorithms.SHA_256);
            ...
            addHMACAlias(configurableProvider, McElieceCCA2ParameterSpec.DEFAULT_MD, aSN1ObjectIdentifier);
        }
    }
