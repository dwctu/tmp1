...
public class CertificateBody extends ASN1Object {
    ...
    private CertificateBody(DERApplicationSpecific dERApplicationSpecific) throws IOException, IllegalArgumentException {
    ...
    private void setIso7816CertificateBody(DERApplicationSpecific dERApplicationSpecific) throws IOException, IllegalArgumentException {
        ...
        while (true) {
            ...
            if (!(object instanceof DERApplicationSpecific)) {
                throw new IOException("Not a valid iso7816 content : not a DERApplicationSpecific Object :" + EACTags.encodeTag(dERApplicationSpecific) + object.getClass());
            }
