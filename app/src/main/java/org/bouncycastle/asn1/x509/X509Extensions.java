...
public class X509Extensions extends ASN1Object {
    ...
    public X509Extensions(Vector vector, Hashtable hashtable) {
        ...
        while (enumerationKeys.hasMoreElements()) {
            this.ordering.addElement(DERObjectIdentifier.getInstance(enumerationKeys.nextElement()));
        }
        Enumeration enumerationElements = this.ordering.elements();
        while (enumerationElements.hasMoreElements()) {
            ASN1ObjectIdentifier dERObjectIdentifier = DERObjectIdentifier.getInstance(enumerationElements.nextElement());
