...
public class KeyPurposeId extends ASN1Object {
    ...
    static {
        ...
        id_kp_eapOverLAN = new KeyPurposeId(aSN1ObjectIdentifier.branch(OrgyEventTrackUtil.AppType.Blog));
        id_kp_scvpServer = new KeyPurposeId(aSN1ObjectIdentifier.branch(OrgyEventTrackUtil.AppType.Life));
    ...
    public static KeyPurposeId getInstance(Object obj) {
        ...
        if (obj != null) {
            return new KeyPurposeId(DERObjectIdentifier.getInstance(obj));
        }
        return null;
    }
