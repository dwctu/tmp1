...
public class DSTU4145NamedCurves {
    ...
    static {
        ...
        int i = 0;
        ECCurve.F2m[] f2mArr = {new ECCurve.F2m(163, 3, 6, 7, bigIntegerValueOf2, new BigInteger("5FF6108462A2DC8210AB403925E638A19C1455D21", 16)), new ECCurve.F2m(167, 6, bigIntegerValueOf2, new BigInteger("6EE3CEEB230811759F20518A0930F1A4315A827DAC", 16)), new ECCurve.F2m(CipherSuite.TLS_RSA_PSK_WITH_AES_256_GCM_SHA384, 1, 2, 10, bigIntegerValueOf, new BigInteger("108576C80499DB2FC16EDDF6853BBB278F6B6FB437D9", 16)), new ECCurve.F2m(CipherSuite.TLS_DHE_PSK_WITH_AES_256_CBC_SHA384, 1, 2, 4, bigIntegerValueOf2, new BigInteger("4A6E0856526436F2F88DD07A341E32D04184572BEB710", 16)), new ECCurve.F2m(191, 9, bigIntegerValueOf2, new BigInteger("7BC86E2102902EC4D5890E8B6B4981ff27E0482750FEFC03", 16)), new ECCurve.F2m(233, 1, 4, 9, bigIntegerValueOf2, new BigInteger("06973B15095675534C7CF7E64A21BD54EF5DD3B8A0326AA936ECE454D2C", 16)), new ECCurve.F2m(257, 12, bigIntegerValueOf, new BigInteger("1CEF494720115657E18F938D7A7942394FF9425C1458C57861F9EEA6ADBE3BE10", 16)), new ECCurve.F2m(307, 2, 4, 8, bigIntegerValueOf2, new BigInteger("393C7F7D53666B5054B5E6C6D3DE94F4296C0C599E2E2E241050DF18B6090BDC90186904968BB", 16)), new ECCurve.F2m(367, 21, bigIntegerValueOf2, new BigInteger("43FC8AD242B0B7A6F3D1627AD5654447556B47BF6AA4A64B0C2AFE42CADAB8F93D92394C79A79755437B56995136", 16)), new ECCurve.F2m(431, 1, 3, 5, bigIntegerValueOf2, new BigInteger("03CE10490F6A708FC26DFE8C3D27C4F94E690134D5BFF988D8D28AAEAEDE975936C66BAC536B18AE2DC312CA493117DAA469C640CAF3", 16))};
        ...
        while (true) {
            ...
            eCDomainParametersArr[i2] = new ECDomainParameters(f2mArr[i2], eCPointArr[i2], bigIntegerArr[i2]);
            i2++;
        }
        while (true) {
