...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_at_nameAtBirth = aSN1ObjectIdentifierBranch2.branch(OrgyEventTrackUtil.AppType.Blog);
        id_isismtt_at_additionalInformation = aSN1ObjectIdentifierBranch2.branch(OrgyEventTrackUtil.AppType.Life);
