...
public class GF2Matrix extends Matrix {
    ...
    private void assignRandomUpperTriangularMatrix(int i, SecureRandom secureRandom) {
        ...
        int i3 = (i + 31) >>> 5;
        this.length = i3;
        this.matrix = (int[][]) Array.newInstance((Class<?>) int.class, i, i3);
        int i4 = i & 31;
    ...
    private void assignUnitMatrix(int i) {
        ...
        this.length = i2;
        int[] iArr = {i, i2};
        this.matrix = (int[][]) Array.newInstance((Class<?>) int.class, iArr);
        for (int i3 = 0; i3 < this.numRows; i3++) {
    ...
    public Matrix computeInverse() {
        ...
        int[][] iArr = (int[][]) Array.newInstance((Class<?>) int.class, i, this.length);
