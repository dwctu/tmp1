    ...
    public PrivateKey generatePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            try {
                ...
                return new BCMcElieceCCA2PrivateKey(new McElieceCCA2PrivateKeySpec("1.3.6.1.4.1.8301.3.1.3.4.2", iIntValue, iIntValue2, octets, octets2, octets3, octets4, bArr));
