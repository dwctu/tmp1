...
public class PKIXNameConstraintValidator {
    ...
    private static String extractHostFromURL(String str) {
        ...
        if (strSubstring.indexOf(ResourceConstants.CMT) != -1) {
            strSubstring = strSubstring.substring(strSubstring.indexOf(ResourceConstants.CMT) + 2);
        }
    ...
    */
    ...
    private boolean withinDomain(String str, String str2) {
        ...
        String[] strArrSplit = Strings.split(str2, FilenameUtils.EXTENSION_SEPARATOR);
        String[] strArrSplit2 = Strings.split(str, FilenameUtils.EXTENSION_SEPARATOR);
