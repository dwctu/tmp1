...
public class JCEDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public byte[] getEncoded() {
        try {
            ...
            return privateKeyInfo != null ? privateKeyInfo.getEncoded(ASN1Encoding.DER) : new PrivateKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, (ASN1Encodable) new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new DERInteger(getX())).getEncoded(ASN1Encoding.DER);
