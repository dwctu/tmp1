...
public class PKCS12Example {
    ...
    public static Certificate createCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) throws Exception {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier = X509Name.C;
        hashtable.put(aSN1ObjectIdentifier, "AU");
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = X509Name.O;
        hashtable.put(aSN1ObjectIdentifier2, "The Legion of the Bouncy Castle");
        ASN1ObjectIdentifier aSN1ObjectIdentifier3 = X509Name.OU;
        ...
        hashtable.put(aSN1ObjectIdentifier4, "feedback-crypto@bouncycastle.org");
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier5 = X509Name.L;
        hashtable2.put(aSN1ObjectIdentifier5, "Melbourne");
        ASN1ObjectIdentifier aSN1ObjectIdentifier6 = X509Name.CN;
        hashtable2.put(aSN1ObjectIdentifier6, "Eric H. Echidna");
        hashtable2.put(aSN1ObjectIdentifier4, "feedback-crypto@bouncycastle.org");
        ...
        X509Certificate x509CertificateGenerate = v3CertGen.generate(privateKey);
        x509CertificateGenerate.checkValidity(new Date());
        x509CertificateGenerate.verify(publicKey2);
        PKCS12BagAttributeCarrier pKCS12BagAttributeCarrier = (PKCS12BagAttributeCarrier) x509CertificateGenerate;
        ...
        return x509CertificateGenerate;
    }
    ...
    public static Certificate createIntermediateCert(PublicKey publicKey, PrivateKey privateKey, X509Certificate x509Certificate) throws Exception {
        ...
        X509Certificate x509CertificateGenerate = v3CertGen.generate(privateKey);
        x509CertificateGenerate.checkValidity(new Date());
        x509CertificateGenerate.verify(x509Certificate.getPublicKey());
        ((PKCS12BagAttributeCarrier) x509CertificateGenerate).setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName, new DERBMPString("Bouncy Intermediate Certificate"));
        return x509CertificateGenerate;
    }
    ...
    public static Certificate createMasterCert(PublicKey publicKey, PrivateKey privateKey) throws Exception {
        ...
        X509Certificate x509CertificateGenerate = v1CertGen.generate(privateKey);
        x509CertificateGenerate.checkValidity(new Date());
        x509CertificateGenerate.verify(publicKey);
        ((PKCS12BagAttributeCarrier) x509CertificateGenerate).setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName, new DERBMPString("Bouncy Primary Certificate"));
        return x509CertificateGenerate;
    }
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        PrivateKey privateKeyGeneratePrivate = keyFactory.generatePrivate(rSAPrivateCrtKeySpec3);
        PublicKey publicKeyGeneratePublic = keyFactory.generatePublic(rSAPublicKeySpec3);
        PrivateKey privateKeyGeneratePrivate2 = keyFactory.generatePrivate(rSAPrivateCrtKeySpec2);
        PublicKey publicKeyGeneratePublic2 = keyFactory.generatePublic(rSAPublicKeySpec2);
        PrivateKey privateKeyGeneratePrivate3 = keyFactory.generatePrivate(rSAPrivateCrtKeySpec);
        PublicKey publicKeyGeneratePublic3 = keyFactory.generatePublic(rSAPublicKeySpec);
        Certificate[] certificateArr = new Certificate[3];
        certificateArr[2] = createMasterCert(publicKeyGeneratePublic, privateKeyGeneratePrivate);
        certificateArr[1] = createIntermediateCert(publicKeyGeneratePublic2, privateKeyGeneratePrivate, (X509Certificate) certificateArr[2]);
        certificateArr[0] = createCert(publicKeyGeneratePublic3, privateKeyGeneratePrivate2, publicKeyGeneratePublic2);
        PKCS12BagAttributeCarrier pKCS12BagAttributeCarrier = (PKCS12BagAttributeCarrier) privateKeyGeneratePrivate3;
        pKCS12BagAttributeCarrier.setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName, new DERBMPString("Eric's Key"));
        pKCS12BagAttributeCarrier.setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_localKeyId, new SubjectKeyIdentifierStructure(publicKeyGeneratePublic3));
        KeyStore keyStore = KeyStore.getInstance("PKCS12", BouncyCastleProvider.PROVIDER_NAME);
        keyStore.load(null, null);
        keyStore.setKeyEntry("Eric's Key", privateKeyGeneratePrivate3, null, certificateArr);
