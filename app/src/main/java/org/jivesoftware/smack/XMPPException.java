...
public abstract class XMPPException extends Exception {
    ...
    public static class StreamErrorException extends XMPPException {
        ...
        public StreamErrorException(StreamError streamError) {
            super(streamError.getCondition().toString() + " You can read more about the meaning of this stream error chat_notification_at http://xmpp.org/rfcs/rfc6120.html#streams-error-conditions\n" + streamError.toString());
