...
public final class ProviderManager {
    ...
    public static void addExtensionProvider(String str, String str2, Object obj) {
        validate(str, str2);
        String strRemoveExtensionProvider = removeExtensionProvider(str, str2);
        if (!(obj instanceof ExtensionElementProvider)) {
            throw new IllegalArgumentException("Provider must be a PacketExtensionProvider");
        }
        extensionProviders.put(strRemoveExtensionProvider, (ExtensionElementProvider) obj);
    }

    public static void addIQProvider(String str, String str2, Object obj) {
        validate(str, str2);
        String strRemoveIQProvider = removeIQProvider(str, str2);
        if (!(obj instanceof IQProvider)) {
            throw new IllegalArgumentException("Provider must be an IQProvider");
        }
        iqProviders.put(strRemoveIQProvider, (IQProvider) obj);
    }
