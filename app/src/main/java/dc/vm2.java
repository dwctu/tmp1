...
/* compiled from: MessageNotificationInterceptorImpl.java */
...
public class vm2 {
    ...
    public class a implements yn2<BaseResponseBean> {
        ...
        public a(vm2 vm2Var, wn2 wn2Var, boolean z) {
            this.a = wn2Var;
            this.b = z;
        }
    ...
    public Subscription a(boolean z, Map<String, Object> map, wn2<Object> wn2Var) {
        return tn2.x(WearUtils.x).i("/api/user/updateUserConfig", map, new a(this, wn2Var, z));
    }
}
