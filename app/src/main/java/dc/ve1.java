...
public class ve1 {
    ...
    public ve1(Context context, ViewGroup viewGroup, Interpolator interpolator, c cVar) {
        if (viewGroup == null) {
    ...
    public static ve1 m(ViewGroup viewGroup, float f, Interpolator interpolator, c cVar) {
        ve1 ve1VarN = n(viewGroup, interpolator, cVar);
        ve1VarN.b = (int) (ve1VarN.b * (1.0f / f));
        return ve1VarN;
    }

    public static ve1 n(ViewGroup viewGroup, Interpolator interpolator, c cVar) {
        return new ve1(viewGroup.getContext(), viewGroup, interpolator, cVar);
    }
    ...
    */
    public boolean I(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.ve1.I(android.view.MotionEvent):boolean");
    }
