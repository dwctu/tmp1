...
public final class g24 {
    ...
    @NotNull
    public static final ThreadLocal<r04> b = new ThreadLocal<>();
    ...
    @NotNull
    public final r04 b() {
        ThreadLocal<r04> threadLocal = b;
        r04 r04Var = threadLocal.get();
        if (r04Var != null) {
            return r04Var;
        }
        r04 r04VarA = u04.a();
        threadLocal.set(r04VarA);
        return r04VarA;
    }
    ...
    public final void d(@NotNull r04 r04Var) {
        b.set(r04Var);
    }
}
