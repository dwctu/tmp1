...
public enum yz3 {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            iArr[yz3.DEFAULT.ordinal()] = 1;
            iArr[yz3.ATOMIC.ordinal()] = 2;
            iArr[yz3.UNDISPATCHED.ordinal()] = 3;
            iArr[yz3.LAZY.ordinal()] = 4;
            a = iArr;
        }
    }
    ...
    public final <T> void invoke(@NotNull Function1<? super Continuation<? super T>, ? extends Object> block, @NotNull Continuation<? super T> completion) throws Throwable {
        int i = a.a[ordinal()];
        if (i == 1) {
            c74.c(block, completion);
            return;
        }
        if (i == 2) {
            ContinuationKt.startCoroutine(block, completion);
        } else if (i == 3) {
            d74.a(block, completion);
        } else if (i != 4) {
    ...
    public final <R, T> void invoke(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> block, R receiver, @NotNull Continuation<? super T> completion) throws Throwable {
        int i = a.a[ordinal()];
        if (i == 1) {
            c74.e(block, receiver, completion, null, 4, null);
            return;
        }
        if (i == 2) {
            ContinuationKt.startCoroutine(block, receiver, completion);
        } else if (i == 3) {
            d74.b(block, receiver, completion);
        } else if (i != 4) {
            throw new NoWhenBranchMatchedException();
        }
    }
