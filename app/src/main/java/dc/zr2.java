...
import com.wear.databinding.ItemChatTextLeftBinding;
...
public final class zr2 extends xr2 {
    ...
    public zr2(@NotNull ie3 emojisUtils, boolean z, @Nullable ChatAdapter.a aVar) {
        super(emojisUtils);
    ...
    public BaseViewHolder m(@NotNull ViewGroup parent, int i) {
        ...
        ItemChatTextLeftBinding itemChatTextLeftBindingB = ItemChatTextLeftBinding.b(LayoutInflater.from(parent.getContext()), parent, false);
        Intrinsics.checkNotNullExpressionValue(itemChatTextLeftBindingB, "inflate(LayoutInflater.f….context), parent, false)");
        View root = itemChatTextLeftBindingB.getRoot();
    ...
    public void a(@NotNull BaseViewHolder helper, @NotNull Message item) {
        ...
        super.a(helper, item);
        ItemChatTextLeftBinding itemChatTextLeftBinding = (ItemChatTextLeftBinding) DataBindingUtil.getBinding(helper.itemView);
        if (itemChatTextLeftBinding != null) {
            itemChatTextLeftBinding.h(item);
        }
        if (itemChatTextLeftBinding != null) {
            itemChatTextLeftBinding.f(Boolean.valueOf(this.g));
        }
        if (itemChatTextLeftBinding != null) {
            itemChatTextLeftBinding.d(Integer.valueOf(getE()));
        }
        if (itemChatTextLeftBinding != null) {
            itemChatTextLeftBinding.e(this.f);
        }
        if (itemChatTextLeftBinding != null) {
            itemChatTextLeftBinding.g(this.h);
        }
        if (itemChatTextLeftBinding != null) {
            itemChatTextLeftBinding.executePendingBindings();
        }
