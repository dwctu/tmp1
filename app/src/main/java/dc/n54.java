...
public final class n54<T> implements u34<T> {
    ...
    public static final class a extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
        public final /* synthetic */ u34<T> $downstream;
        public /* synthetic */ Object L$0;
        public int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public a(u34<? super T> u34Var, Continuation<? super a> continuation) {
            super(2, continuation);
            this.$downstream = u34Var;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                u34<T> u34Var = this.$downstream;
                this.label = 1;
                if (u34Var.emit(obj2, this) == coroutine_suspended) {
    ...
    public n54(@NotNull u34<? super T> u34Var, @NotNull CoroutineContext coroutineContext) {
        this.a = coroutineContext;
        this.b = x64.b(coroutineContext);
        this.c = new a(u34Var, null);
    }

    @Override // dc.u34
    @Nullable
    public Object emit(T t, @NotNull Continuation<? super Unit> continuation) {
        Object objB = y44.b(this.a, t, this.b, this.c, continuation);
