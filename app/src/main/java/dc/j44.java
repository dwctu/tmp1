...
public final class j44<T> extends o34<T> {

    @NotNull
    public final Function2<u34<? super T>, Continuation<? super Unit>, Object> a;

    /* JADX WARN: Multi-variable type inference failed */
    public j44(@NotNull Function2<? super u34<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        this.a = function2;
    }

    @Override // dc.o34
    @Nullable
    public Object c(@NotNull u34<? super T> u34Var, @NotNull Continuation<? super Unit> continuation) {
        Object objInvoke = this.a.invoke(u34Var, continuation);
