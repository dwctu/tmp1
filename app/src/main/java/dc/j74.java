...
public class j74 extends x04 {
    ...
    public j74(int i, int i2, long j, @NotNull String str) {
        this.a = i;
        this.b = i2;
        this.c = j;
        this.d = str;
    ...
    public final void I(@NotNull Runnable runnable, @NotNull m74 m74Var, boolean z) {
        this.e.m(runnable, m74Var, z);
    }

    @Override // dc.qz3
    public void dispatch(@NotNull CoroutineContext context, @NotNull Runnable block) {
        e74.p(this.e, block, null, false, 6, null);
    }

    @Override // dc.qz3
    public void dispatchYield(@NotNull CoroutineContext context, @NotNull Runnable block) {
        e74.p(this.e, block, null, true, 2, null);
    }

    public final e74 y() {
        return new e74(this.a, this.b, this.c, this.d);
    }
}
