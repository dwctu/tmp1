...
public abstract class qz3 extends AbstractCoroutineContextElement implements ContinuationInterceptor {
    ...
    /* renamed from: dc.qz3$a, reason: from kotlin metadata */
    public static final class Companion extends AbstractCoroutineContextKey<ContinuationInterceptor, qz3> {
        ...
        /* renamed from: dc.qz3$a$a, reason: collision with other inner class name */
        public static final class C0210a extends Lambda implements Function1<CoroutineContext.Element, qz3> {
            ...
            public final qz3 invoke(@NotNull CoroutineContext.Element element) {
                if (element instanceof qz3) {
                    return (qz3) element;
                }
                return null;
            }
        ...
        public Companion() {
            super(ContinuationInterceptor.INSTANCE, C0210a.a);
        }
    ...
    public final <T> Continuation<T> interceptContinuation(@NotNull Continuation<? super T> continuation) {
        return new w54(this, continuation);
    }
    ...
    @NotNull
    public final qz3 plus(@NotNull qz3 qz3Var) {
        return qz3Var;
    }
