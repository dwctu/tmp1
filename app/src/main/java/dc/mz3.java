...
public final class mz3 {
    ...
    public static final <T> Object a(@Nullable Object obj, @NotNull Continuation<? super T> continuation) {
        ...
        Throwable thJ = ((jz3) obj).a;
        if (a04.d() && (continuation instanceof CoroutineStackFrame)) {
            thJ = s64.j(thJ, (CoroutineStackFrame) continuation);
        }
        return Result.m86constructorimpl(ResultKt.createFailure(thJ));
    }
    ...
    public static final <T> Object b(@NotNull Object obj, @Nullable Function1<? super Throwable, Unit> function1) {
        ...
        return thM89exceptionOrNullimpl == null ? function1 != null ? new CompletedWithCancellation(obj, function1) : obj : new jz3(thM89exceptionOrNullimpl, false, 2, null);
    }

    @Nullable
    public static final <T> Object c(@NotNull Object obj, @NotNull yy3<?> yy3Var) {
        Throwable thM89exceptionOrNullimpl = Result.m89exceptionOrNullimpl(obj);
        if (thM89exceptionOrNullimpl != null) {
            if (a04.d() && (yy3Var instanceof CoroutineStackFrame)) {
                thM89exceptionOrNullimpl = s64.j(thM89exceptionOrNullimpl, (CoroutineStackFrame) yy3Var);
            }
            obj = new jz3(thM89exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
