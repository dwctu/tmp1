...
public final class n24 {
    ...
    static {
        ...
        try {
            ...
            objM86constructorimpl = Result.m86constructorimpl(new l24(a(Looper.getMainLooper(), true), b2 == true ? 1 : 0, 2, b == true ? 1 : 0));
        } catch (Throwable th) {
    ...
    @VisibleForTesting
    @NotNull
    public static final Handler a(@NotNull Looper looper, boolean z) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        int i;
