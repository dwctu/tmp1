...
public interface yy3<T> extends Continuation<T> {
    ...
    void i(T t, @Nullable Function1<? super Throwable, Unit> function1);

    boolean isActive();

    @Nullable
    Object l(T t, @Nullable Object obj, @Nullable Function1<? super Throwable, Unit> function1);

    void n(@NotNull qz3 qz3Var, T t);
