...
public final class l54<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public l54(@NotNull Continuation<? super T> continuation, @NotNull CoroutineContext coroutineContext) {
        this.a = continuation;
