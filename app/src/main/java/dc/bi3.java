...
public class bi3 extends uh3 {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            bi3.this.k[0] = ii3.d(MyApplication.N(), "filter/edgeburn.png");
            bi3.this.k[1] = ii3.d(MyApplication.N(), "filter/hefemap.png");
            bi3.this.k[2] = ii3.d(MyApplication.N(), "filter/hefemetal.png");
            bi3.this.k[3] = ii3.d(MyApplication.N(), "filter/hefesoftlight.png");
        }
    }
