...
/* renamed from: dc.iz3, reason: from toString */
...
public final /* data */ class CompletedContinuation {
    ...
    @JvmField
    @Nullable
    public final wy3 cancelHandler;
    ...
    public CompletedContinuation(@Nullable Object obj, @Nullable wy3 wy3Var, @Nullable Function1<? super Throwable, Unit> function1, @Nullable Object obj2, @Nullable Throwable th) {
        this.result = obj;
        this.cancelHandler = wy3Var;
        this.onCancellation = function1;
        this.idempotentResume = obj2;
        this.cancelCause = th;
    }

    public static /* synthetic */ CompletedContinuation b(CompletedContinuation completedContinuation, Object obj, wy3 wy3Var, Function1 function1, Object obj2, Throwable th, int i, Object obj3) {
        if ((i & 1) != 0) {
            obj = completedContinuation.result;
        }
        if ((i & 2) != 0) {
            wy3Var = completedContinuation.cancelHandler;
        }
        wy3 wy3Var2 = wy3Var;
        if ((i & 4) != 0) {
        ...
        return completedContinuation.a(obj, wy3Var2, function12, obj4, th);
    }

    @NotNull
    public final CompletedContinuation a(@Nullable Object obj, @Nullable wy3 wy3Var, @Nullable Function1<? super Throwable, Unit> function1, @Nullable Object obj2, @Nullable Throwable th) {
        return new CompletedContinuation(obj, wy3Var, function1, obj2, th);
    }
    ...
    public final void d(@NotNull zy3<?> zy3Var, @NotNull Throwable th) {
        wy3 wy3Var = this.cancelHandler;
        if (wy3Var != null) {
            zy3Var.o(wy3Var, th);
        }
    ...
    public int hashCode() {
        ...
        wy3 wy3Var = this.cancelHandler;
        int iHashCode2 = (iHashCode + (wy3Var == null ? 0 : wy3Var.hashCode())) * 31;
        Function1<Throwable, Unit> function1 = this.onCancellation;
    ...
    public /* synthetic */ CompletedContinuation(Object obj, wy3 wy3Var, Function1 function1, Object obj2, Throwable th, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(obj, (i & 2) != 0 ? null : wy3Var, (i & 4) != 0 ? null : function1, (i & 8) != 0 ? null : obj2, (i & 16) != 0 ? null : th);
    }
}
