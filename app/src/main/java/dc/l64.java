...
public final class l64 {
    ...
    public static final m64 a(Throwable th, String str) throws Throwable {
        if (a) {
            return new m64(th, str);
        }
        if (th != null) {
            throw th;
        }
    ...
    public static /* synthetic */ m64 b(Throwable th, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            th = null;
        }
        if ((i & 2) != 0) {
    ...
    public static final boolean c(@NotNull s14 s14Var) {
        return s14Var.y() instanceof m64;
    }
    ...
    @NotNull
    public static final s14 e(@NotNull j64 j64Var, @NotNull List<? extends j64> list) {
        try {
            return j64Var.createDispatcher(list);
        } catch (Throwable th) {
            return a(th, j64Var.hintOnError());
        }
    }
}
