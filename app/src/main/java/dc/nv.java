...
public final class nv extends jv implements gu {
    ...
    public nv(@Nullable UUID uuid, @Nullable UUID uuid2, @Nullable zv zvVar) {
        super(zvVar);
        this.i = uuid;
        this.j = uuid2;
    }
