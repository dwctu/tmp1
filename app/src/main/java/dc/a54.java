...
public final class a54<T> extends z44<T, T> {
    public /* synthetic */ a54(t34 t34Var, CoroutineContext coroutineContext, int i, s24 s24Var, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(t34Var, (i2 & 2) != 0 ? EmptyCoroutineContext.INSTANCE : coroutineContext, (i2 & 4) != 0 ? -3 : i, (i2 & 8) != 0 ? s24.SUSPEND : s24Var);
    }

    @Override // dc.x44
    @NotNull
    public x44<T> f(@NotNull CoroutineContext coroutineContext, int i, @NotNull s24 s24Var) {
        return new a54(this.d, coroutineContext, i, s24Var);
    }

    @Override // dc.z44
    @Nullable
    public Object m(@NotNull u34<? super T> u34Var, @NotNull Continuation<? super Unit> continuation) {
        Object objCollect = this.d.collect(u34Var, continuation);
        return objCollect == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }

    public a54(@NotNull t34<? extends T> t34Var, @NotNull CoroutineContext coroutineContext, int i, @NotNull s24 s24Var) {
