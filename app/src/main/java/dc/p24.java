...
public final class p24 {
    ...
    @JvmField
    @NotNull
    public static final t64 a = new t64("EMPTY");

    @JvmField
    @NotNull
    public static final t64 b = new t64("OFFER_SUCCESS");

    @JvmField
    @NotNull
    public static final t64 c = new t64("OFFER_FAILED");

    @JvmField
    @NotNull
    public static final t64 d = new t64("POLL_FAILED");

    @JvmField
    @NotNull
    public static final t64 e = new t64("ENQUEUE_FAILED");

    @JvmField
    @NotNull
    public static final t64 f = new t64("ON_CLOSE_HANDLER_INVOKED");
}
