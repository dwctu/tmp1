...
/* compiled from: PatternFragmentInterceptorImpl.java */
...
public class dn2 {
    ...
    public class a implements yn2<BaseResponseBean> {
        ...
        public a(dn2 dn2Var, wn2 wn2Var, boolean z) {
            this.a = wn2Var;
            this.b = z;
        }
    ...
    public Subscription a(boolean z, Map<String, Object> map, wn2<Object> wn2Var) {
        return tn2.x(WearUtils.x).j("/wear/pattern/v2/find", map, new a(this, wn2Var, z));
    }
}
