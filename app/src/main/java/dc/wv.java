...
public final class wv extends jv implements fu {
    ...
    public wv(@Nullable UUID uuid, @Nullable UUID uuid2, @Nullable byte[] bArr, @Nullable zv zvVar, boolean z) {
        super(zvVar);
        this.i = uuid;
        this.j = uuid2;
        this.k = bArr;
    ...
    */
    public final boolean b0(android.bluetooth.BluetoothGattCharacteristic r4, int r5, byte[] r6) {
        ...
        L35:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.wv.b0(android.bluetooth.BluetoothGattCharacteristic, int, byte[]):boolean");
    }

    public final void c0() {
        if (!Y(this.i, this.j, this.k)) {
            z(mt.REQUEST_FAILED);
        } else if (this.l) {
            V();
        } else {
