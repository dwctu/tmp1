...
public class jh0 {
    ...
    public class a implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            jh0.this.j.b(scaleFactor, scaleGestureDetector.getFocusX(), scaleGestureDetector.getFocusY());
            return true;
        }
    ...
    public jh0(Context context, kh0 kh0Var) {
    ...
    public final boolean g(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            int iB = th0.b(motionEvent.getAction());
