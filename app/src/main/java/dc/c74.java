...
public final class c74 {
    public static final void a(Continuation<?> continuation, Throwable th) throws Throwable {
        ...
        continuation.resumeWith(Result.m86constructorimpl(ResultKt.createFailure(th)));
        throw th;
    }

    public static final void b(@NotNull Continuation<? super Unit> continuation, @NotNull Continuation<?> continuation2) throws Throwable {
        try {
            Continuation continuationIntercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation);
            Result.Companion companion = Result.INSTANCE;
            x54.c(continuationIntercepted, Result.m86constructorimpl(Unit.INSTANCE), null, 2, null);
        } catch (Throwable th) {
            a(continuation2, th);
            throw null;
        }
    ...
    public static final <T> void c(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) throws Throwable {
        try {
    ...
    public static final <R, T> void d(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, @NotNull Continuation<? super T> continuation, @Nullable Function1<? super Throwable, Unit> function1) throws Throwable {
        try {
            ...
            Result.Companion companion = Result.INSTANCE;
            x54.b(continuationIntercepted, Result.m86constructorimpl(Unit.INSTANCE), function1);
        } catch (Throwable th) {
            a(continuation, th);
            throw null;
        }
