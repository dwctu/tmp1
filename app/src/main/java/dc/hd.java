...
public final class hd {
    ...
    public static void a(Path path, float f2, float f3, float f4) {
        ...
        if (fMin >= length && fMax >= length) {
            fMin = gd.g(fMin, length);
            fMax = gd.g(fMax, length);
        }
        if (fMin < 0.0f) {
            fMin = gd.g(fMin, length);
        }
    ...
    public static void b(Path path, @Nullable o8 o8Var) {
        if (o8Var == null || o8Var.j()) {
            return;
        }
        a(path, ((r8) o8Var.h()).p() / 100.0f, ((r8) o8Var.d()).p() / 100.0f, ((r8) o8Var.f()).p() / 360.0f);
    }
    ...
    public static void n(Canvas canvas, RectF rectF, Paint paint, int i) {
        e7.a("Utils#saveLayer");
        if (Build.VERSION.SDK_INT < 23) {
            canvas.saveLayer(rectF, paint, i);
        } else {
            canvas.saveLayer(rectF, paint);
        }
        e7.b("Utils#saveLayer");
    }
}
