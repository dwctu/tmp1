...
/* compiled from: GetCharAsciiUtils.java */
...
public class ga0 {
    ...
    public static boolean f(String str) {
        return !re0.e(str) && str.split(",").length == 1 && Pattern.compile("^(\\d+)(.*)").matcher(str).matches() && str.indexOf(";") == str.length() - 1 && str.indexOf("b,") == -1;
    }
