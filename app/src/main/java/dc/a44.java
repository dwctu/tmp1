...
public final /* synthetic */ class a44 {
    ...
    @NotNull
    public static final <T> t34<T> a(@NotNull t34<? extends T> t34Var) {
        return t34Var instanceof o44 ? t34Var : b(t34Var, a, b);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> t34<T> b(t34<? extends T> t34Var, Function1<? super T, ? extends Object> function1, Function2<Object, Object, Boolean> function2) {
        if (t34Var instanceof s34) {
            s34 s34Var = (s34) t34Var;
            if (s34Var.b == function1 && s34Var.c == function2) {
                return t34Var;
            }
        }
        return new s34(t34Var, function1, function2);
    }
}
