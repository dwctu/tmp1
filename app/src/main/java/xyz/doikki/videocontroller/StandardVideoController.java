...
public class StandardVideoController extends GestureVideoController implements View.OnClickListener {
    ...
    public int getLayoutId() {
        return jj4.dkplayer_layout_standard_controller;
    }

    @Override // android.view.View.OnClickListener
    public void onClick(View view) {
        if (view.getId() == ij4.lock) {
            this.a.m();
        }
    }
    ...
    public void s() {
        super.s();
        ImageView imageView = (ImageView) findViewById(ij4.lock);
        this.G = imageView;
        imageView.setOnClickListener(this);
        this.K = (ProgressBar) findViewById(ij4.loading);
    }
    ...
    public void t(boolean z) {
        if (z) {
            ...
            Toast.makeText(getContext(), kj4.dkplayer_locked, 0).show();
        } else {
            this.G.setSelected(false);
            Toast.makeText(getContext(), kj4.dkplayer_unlocked, 0).show();
        }
    }
