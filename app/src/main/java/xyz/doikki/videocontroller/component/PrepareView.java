...
public class PrepareView extends FrameLayout implements nj4 {
    ...
    public PrepareView(@NonNull Context context) {
        super(context);
        LayoutInflater.from(getContext()).inflate(jj4.dkplayer_layout_prepare_view, (ViewGroup) this, true);
        this.b = (ImageView) findViewById(ij4.thumb);
        this.c = (ImageView) findViewById(ij4.start_play);
        this.d = (ProgressBar) findViewById(ij4.loading);
        this.e = (FrameLayout) findViewById(ij4.net_warning_layout);
