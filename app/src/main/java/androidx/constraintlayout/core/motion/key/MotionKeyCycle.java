...
public class MotionKeyCycle extends MotionKey {
    ...
    public void dump() {
        System.out.println("MotionKeyCycle{mWaveShape=" + this.mWaveShape + ", mWavePeriod=" + this.mWavePeriod + ", mWaveOffset=" + this.mWaveOffset + ", mWavePhase=" + this.mWavePhase + ", mRotation=" + this.mRotation + MessageFormatter.DELIM_STOP);
    }
    ...
    */
    ...
    public void printAttributes() {
        ...
        Utils.log("MotionKeyCycle{Shape=" + this.mWaveShape + ", Period=" + this.mWavePeriod + ", Offset=" + this.mWaveOffset + ", Phase=" + this.mWavePhase + MessageFormatter.DELIM_STOP);
        String[] strArr = (String[]) hashSet.toArray(new String[0]);
        for (int i = 0; i < strArr.length; i++) {
            z.a(strArr[i]);
            Utils.log(strArr[i] + SignatureImpl.INNER_SEP + getValue(strArr[i]));
        }
    }
