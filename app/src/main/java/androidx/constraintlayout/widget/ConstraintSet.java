...
public class ConstraintSet {
    ...
    public static class Constraint {
        ...
        public static class Delta {
            ...
            public void printDelta(String str) {
                for (int i = 0; i < this.mCountInt; i++) {
                    String str2 = this.mTypeInt[i] + " = " + this.mValueInt[i];
                }
                for (int i2 = 0; i2 < this.mCountFloat; i2++) {
                    String str3 = this.mTypeFloat[i2] + " = " + this.mValueFloat[i2];
                }
                for (int i3 = 0; i3 < this.mCountString; i3++) {
                    String str4 = this.mTypeString[i3] + " = " + this.mValueString[i3];
                }
                for (int i4 = 0; i4 < this.mCountBoolean; i4++) {
                    String str5 = this.mTypeBoolean[i4] + " = " + this.mValueBoolean[i4];
                }
            }
    ...
    public class WriteXmlEngine {
        ...
        public void writeVariable(String str, int[] iArr) throws IOException {
            ...
            this.writer.write(SPACE + str);
            this.writer.write(SignatureImpl.INNER_SEP);
            int i = 0;
            while (i < iArr.length) {
    ...
    public static String getDebugName(int i) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(Config.IN_FIELD_SEPARATOR) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    public static void parseDimensionConstraints(Object obj, TypedArray typedArray, int i, int i2) {
        ...
        if (i3 != 5) {
            ...
            if (i4 != -4) {
                dimensionPixelSize = (i4 == -3 || !(i4 == -2 || i4 == -1)) ? 0 : i4;
            } else {
                z = true;
            }
        } else {
    ...
    private static void populateOverride(Context context, Constraint constraint, TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case 92:
                default:
                    String str = "Unknown attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index);
                    break;
                case 5:
                ...
                case 87:
                    String str2 = "unused attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index);
                    break;
                case 93:
    ...
    public void parseColorAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < strArrSplit.length; i++) {
            ...
            if (strArrSplit2.length != 2) {
                String str2 = " Unable to parse " + strArrSplit[i];
            } else {
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < strArrSplitString.length; i++) {
            ...
            String str2 = " Unable to parse " + strArrSplitString[i];
    ...
    public class WriteJsonEngine {
        ...
        public void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                Layout layout = constraint.layout;
                writeDimension(VideoCaptureFormat.keyHeight, layout.mHeight, layout.heightDefault, layout.heightPercent, layout.heightMin, layout.heightMax, layout.constrainedHeight);
                writeDimension(VideoCaptureFormat.keyWidth, layout.mWidth, layout.widthDefault, layout.widthPercent, layout.widthMin, layout.widthMax, layout.constrainedWidth);
