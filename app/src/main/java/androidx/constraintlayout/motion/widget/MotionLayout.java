...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> map, int i, int i2) {
            ...
            if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + SignatureImpl.INNER_SEP + MotionLayout.this.getProgress();
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str5 = Config.IN_FIELD_SEPARATOR;
                sb.append(constraintAnchor != null ? ExifInterface.GPS_DIRECTION_TRUE : Config.IN_FIELD_SEPARATOR);
                String string = sb.toString();
                StringBuilder sb2 = new StringBuilder();
                sb2.append(string);
                sb2.append(constraintWidget.mBottom.mTarget != null ? "B" : Config.IN_FIELD_SEPARATOR);
                String string2 = sb2.toString();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(string2);
                sb3.append(constraintWidget.mLeft.mTarget != null ? "L" : Config.IN_FIELD_SEPARATOR);
                ...
                String str6 = str4 + "  " + name + " " + constraintWidget + " " + string4;
            }
  ...
  0x00e6: PHI (r2v48 float) = (r2v47 float), (r2v49 float), (r2v49 float) binds: [B:47:0x00ae, B:58:0x00da, B:60:0x00de] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void getAnchorDpDt(int i, float f, float f2, float f3, float[] fArr) throws Resources.NotFoundException {
        String resourceName;
    ...
    */
    ...
    public static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f4me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f4me.tracker = VelocityTracker.obtain();
            return f4me;
        }
