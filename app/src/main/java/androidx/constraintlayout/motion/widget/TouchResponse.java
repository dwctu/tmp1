...
public class TouchResponse {
    ...
    public float getProgressDirection(float f, float f2) throws Resources.NotFoundException {
    ...
    public void processTouchEvent(MotionEvent motionEvent, MotionLayout.MotionTracker motionTracker, int i, MotionScene motionScene) throws Resources.NotFoundException {
        int i2;
        ...
        if (action != 1) {
            ...
            if (Math.abs((this.mTouchDirectionX * rawX) + (this.mTouchDirectionY * rawY)) > this.mDragThreshold || this.mDragStarted) {
                ...
                float fMax = Math.max(Math.min(progress + (this.mTouchDirectionX != 0.0f ? rawX / this.mAnchorDpDt[0] : rawY / this.mAnchorDpDt[1]), 1.0f), 0.0f);
        ...
        if (i4 != -1) {
            ...
            fArr4[1] = this.mTouchDirectionY * fMin2;
            fArr4[0] = fMin2 * this.mTouchDirectionX;
        }
        float f2 = this.mTouchDirectionX;
        float[] fArr5 = this.mAnchorDpDt;
        float f3 = fArr5[0];
        float f4 = fArr5[1];
        float fAbs = f2 != 0.0f ? xVelocity / fArr5[0] : yVelocity / fArr5[1];
    ...
    */
    ...
    public void scrollMove(float f, float f2) throws Resources.NotFoundException {
        float progress = this.mMotionLayout.getProgress();
        if (!this.mDragStarted) {
            this.mDragStarted = true;
            this.mMotionLayout.setProgress(progress);
    ...
    public void scrollUp(float f, float f2) throws Resources.NotFoundException {
        this.mDragStarted = false;
        float progress = this.mMotionLayout.getProgress();
        this.mMotionLayout.getAnchorDpDt(this.mTouchAnchorId, progress, this.mTouchAnchorX, this.mTouchAnchorY, this.mAnchorDpDt);
        float f3 = this.mTouchDirectionX;
