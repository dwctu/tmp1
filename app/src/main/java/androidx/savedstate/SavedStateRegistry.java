...
public final class SavedStateRegistry {
    ...
    public static final void m62performAttach$lambda4(SavedStateRegistry this$0, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
    ...
    public final void performAttach$savedstate_release(@NotNull Lifecycle lifecycle) {
        ...
        lifecycle.addObserver(new LifecycleEventObserver() { // from class: dc.n6
            @Override // androidx.lifecycle.LifecycleEventObserver
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                SavedStateRegistry.m62performAttach$lambda4(this.a, lifecycleOwner, event);
            }
        });
        this.attached = true;
    }
    ...
    @MainThread
    public final void runOnNextRecreation(@NotNull Class<? extends AutoRecreated> clazz) throws NoSuchMethodException, SecurityException {
