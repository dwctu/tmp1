...
public final class SplitRuleParser {
    private final ComponentName buildClassName(String pkg, CharSequence clsSeq) {
        if (clsSeq != null) {
            if (!(clsSeq.length() == 0)) {
                ...
                int iIndexOf$default = StringsKt__StringsKt.indexOf$default((CharSequence) string, IOUtils.DIR_SEPARATOR_UNIX, 0, false, 6, (Object) null);
                ...
                if (Intrinsics.areEqual(string, "*") || StringsKt__StringsKt.indexOf$default((CharSequence) string, FilenameUtils.EXTENSION_SEPARATOR, 0, false, 6, (Object) null) >= 0) {
    ...
    private final ActivityRule parseSplitActivityRule(Context context, XmlResourceParser parser) {
        return new ActivityRule(SetsKt__SetsKt.emptySet(), context.getTheme().obtainStyledAttributes(parser, R.styleable.ActivityRule, 0, 0).getBoolean(R.styleable.ActivityRule_alwaysExpand, false));
    }
