...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public static final class SplitListenerWrapper {
        ...
        public static final void m69accept$lambda1(SplitListenerWrapper this$0, List splitsWithActivity) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        public final void accept(@NotNull List<SplitInfo> splitInfoList) {
            ...
            this.executor.execute(new Runnable() { // from class: dc.u6
                @Override // java.lang.Runnable
                public final void run() {
                    ExtensionEmbeddingBackend.SplitListenerWrapper.m69accept$lambda1(this.a, arrayList);
                }
            });
        }
