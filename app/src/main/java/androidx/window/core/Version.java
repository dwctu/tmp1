...
public final class Version implements Comparable<Version> {
    ...
    public static final class Companion {
        ...
        public final Version parse(@Nullable String versionString) {
            if (versionString == null || StringsKt__StringsJVMKt.isBlank(versionString)) {
                return null;
            }
    ...
    private Version(int i, int i2, int i3, String str) {
        ...
        this.bigInteger = LazyKt__LazyJVMKt.lazy(new Function0<BigInteger>() { // from class: androidx.window.core.Version$bigInteger$2
            {
                super(0);
            }
    ...
    public String toString() {
        return this.major + FilenameUtils.EXTENSION_SEPARATOR + this.minor + FilenameUtils.EXTENSION_SEPARATOR + this.patch + (StringsKt__StringsJVMKt.isBlank(this.description) ^ true ? Intrinsics.stringPlus(Constants.FILENAME_SEQUENCE_SEPARATOR, this.description) : "");
    }
