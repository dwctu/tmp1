...
public class BrowserActionsIntent {
    ...
    public static final class Builder {
        ...
        public BrowserActionsIntent build() {
            ...
            this.mIntent.putExtra(BrowserActionsIntent.EXTRA_APP_ID, PendingIntent.getActivity(this.mContext, 0, new Intent(), AudioRoutingController.DEVICE_OUT_USB_HEADSET));
