...
public final class SavedStateHandle {
    ...
    @NotNull
    private final Map<String, g44<Object>> flows;
    ...
    public SavedStateHandle(@NotNull Map<String, ? extends Object> initialState) {
        ...
        this.savedStateProvider = new SavedStateRegistry.SavedStateProvider() { // from class: dc.y3
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return SavedStateHandle.m25savedStateProvider$lambda0(this.a);
            }
        };
    ...
    public static final Bundle m25savedStateProvider$lambda0(SavedStateHandle this$0) {
    ...
    @MainThread
    @NotNull
    public final <T> o44<T> getStateFlow(@NotNull String key, T t) {
        Intrinsics.checkNotNullParameter(key, "key");
        Map<String, g44<Object>> map = this.flows;
        g44<Object> g44VarA = map.get(key);
        if (g44VarA == null) {
            if (!this.regular.containsKey(key)) {
                this.regular.put(key, t);
            }
            g44VarA = q44.a(this.regular.get(key));
            this.flows.put(key, g44VarA);
            map.put(key, g44VarA);
        }
        return v34.b(g44VarA);
    }
    ...
    public final <T> void set(@NotNull String key, @Nullable T value) {
        ...
        g44<Object> g44Var = this.flows.get(key);
        if (g44Var == null) {
            return;
        }
        g44Var.setValue(value);
    }
    ...
    public static final class SavingStateLiveData<T> extends MutableLiveData<T> {
        ...
        public void setValue(T value) {
            ...
            if (savedStateHandle != null) {
                ...
                g44 g44Var = (g44) savedStateHandle.flows.get(this.key);
                if (g44Var != null) {
                    g44Var.setValue(value);
                }
            }
