...
public final class LifecycleController {
    ...
    public LifecycleController(@NotNull Lifecycle lifecycle, @NotNull Lifecycle.State minState, @NotNull DispatchQueue dispatchQueue, @NotNull final h14 parentJob) {
        ...
        LifecycleEventObserver lifecycleEventObserver = new LifecycleEventObserver() { // from class: dc.x3
            @Override // androidx.lifecycle.LifecycleEventObserver
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                LifecycleController.m24observer$lambda0(this.a, parentJob, lifecycleOwner, event);
            }
        };
        ...
        if (lifecycle.getCurrentState() != Lifecycle.State.DESTROYED) {
            ...
            h14.a.a(parentJob, null, 1, null);
            finish();
        }
    }

    private final void handleDestroy(h14 h14Var) {
    ...
    public static final void m24observer$lambda0(LifecycleController this$0, h14 parentJob, LifecycleOwner source, Lifecycle.Event event) {
