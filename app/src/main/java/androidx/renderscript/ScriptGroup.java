...
public final class ScriptGroup extends BaseObj {
    ...
    public static final class Builder2 {
        ...
        public ScriptGroup create(String str, Future... futureArr) {
            if (str == null || str.isEmpty() || str.length() > 100 || !str.equals(str.replaceAll("[^a-zA-Z0-9-]", Config.IN_FIELD_SEPARATOR))) {
    ...
    public Object[] execute(Object... objArr) {
        if (objArr.length < this.mInputs2.size()) {
            String str = toString() + " receives " + objArr.length + " inputs, less than expected " + this.mInputs2.size();
            return null;
        }
        if (objArr.length > this.mInputs2.size()) {
            String str2 = toString() + " receives " + objArr.length + " inputs, more than expected " + this.mInputs2.size();
        }
        int i = 0;
        for (int i2 = 0; i2 < this.mInputs2.size(); i2++) {
            Object obj = objArr[i2];
            if ((obj instanceof Future) || (obj instanceof Input)) {
                String str3 = toString() + ": input " + i2 + " is a future or unbound value";
                return null;
            }
    ...
    public static final class Builder {
        ...
        private boolean calcOrderRecurse(Node node, int i) {
            ...
            while (it.hasNext()) {
                ...
                Node nodeFindNode = fieldID != null ? findNode(fieldID.mScript) : findNode(next.mToK.mScript);
