    ...
    private FragmentTransaction doTabChanged(String str, FragmentTransaction fragmentTransaction) {
        ...
        if (this.mLastTab != tabInfo) {
            ...
            if (tabInfo != null) {
                ...
                if (fragment2 == null) {
                    Fragment fragmentInstantiate = Fragment.instantiate(this.mContext, tabInfo.clss.getName(), tabInfo.args);
                    tabInfo.fragment = fragmentInstantiate;
                    fragmentTransaction.add(this.mContainerId, fragmentInstantiate, tabInfo.tag);
                } else {
