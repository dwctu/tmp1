...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        */
        public android.widget.RemoteViews applyStandardTemplate(boolean r17, int r18, boolean r19) throws android.content.res.Resources.NotFoundException {
            /*
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        boolean z = i3 >= 24 ? action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES) || action.getAllowGeneratedReplies() : action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES);
        ...
        boolean zIsAuthenticationRequired = i3 >= 31 ? action.isAuthenticationRequired() : false;
        if (i3 < 23) {
        ...
        return new Action(i, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z, semanticAction, z2, zIsContextual, zIsAuthenticationRequired);
    }
