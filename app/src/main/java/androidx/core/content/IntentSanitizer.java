...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new Predicate() { // from class: dc.t0
        ...
        private Predicate<Uri> mAllowedData = new Predicate() { // from class: dc.x0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return s2.$default$and(this, predicate);
            }
        ...
        private Predicate<String> mAllowedTypes = new Predicate() { // from class: dc.p0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return s2.$default$and(this, predicate);
            }
        ...
        private Predicate<String> mAllowedCategories = new Predicate() { // from class: dc.y0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return s2.$default$and(this, predicate);
            }
        ...
        private Predicate<String> mAllowedPackages = new Predicate() { // from class: dc.w0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return s2.$default$and(this, predicate);
            }
        ...
        private Predicate<ComponentName> mAllowedComponents = new Predicate() { // from class: dc.d1
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return s2.$default$and(this, predicate);
            }
        ...
        private Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: dc.q0
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return s2.$default$and(this, predicate);
            }
        ...
        private Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: dc.f1
            @Override // androidx.core.util.Predicate
            public /* synthetic */ Predicate and(Predicate predicate) {
                return s2.$default$and(this, predicate);
            }
        ...
        public static /* synthetic */ boolean f(Class cls, Predicate predicate, Object obj) {
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new Predicate() { // from class: dc.s0
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return s2.$default$and(this, predicate);
                }
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new l1(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new Predicate() { // from class: dc.v0
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return s2.$default$and(this, predicate);
                }
        ...
        public Builder allowComponent(@NonNull final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: dc.k1
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return s2.$default$and(this, predicate);
                }
        ...
        public Builder allowComponentWithPackage(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowComponent(new Predicate() { // from class: dc.b1
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return s2.$default$and(this, predicate);
                }
        ...
        public Builder allowDataWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowData(new Predicate() { // from class: dc.z0
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return s2.$default$and(this, predicate);
                }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Class<?> cls) {
            return allowExtra(str, cls, new Predicate() { // from class: dc.a1
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return s2.$default$and(this, predicate);
                }
                ...
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return IntentSanitizer.Builder.e(obj);
                }
            });
        }
        ...
        public Builder allowExtraOutput(@NonNull final String str) {
            allowExtra("output", Uri.class, new Predicate() { // from class: dc.r0
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return s2.$default$and(this, predicate);
                }
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: dc.c1
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return s2.$default$and(this, predicate);
                }
        ...
        public Builder allowPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage(new l1(str));
        }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull final Class<T> cls, @NonNull final Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new Predicate() { // from class: dc.e1
                @Override // androidx.core.util.Predicate
                ...
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return IntentSanitizer.Builder.f(cls, predicate, obj);
                }
            });
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = new Predicate() { // from class: dc.u0
                    @Override // androidx.core.util.Predicate
                    public /* synthetic */ Predicate and(Predicate predicate3) {
                        return s2.$default$and(this, predicate3);
                    }
                    ...
                    public /* synthetic */ Predicate or(Predicate predicate3) {
                        return s2.$default$or(this, predicate3);
                    }

                    @Override // androidx.core.util.Predicate
                    public final boolean test(Object obj) {
                        return IntentSanitizer.Builder.g(obj);
                    }
                };
            }
    ...
    public Intent sanitize(@NonNull Intent intent, @NonNull Consumer<String> consumer) {
        ...
        if ((this.mAllowAnyComponent && component == null) || this.mAllowedComponents.test(component)) {
            ...
            intent2.setComponent(new ComponentName(DefaultSettingsSpiCall.ANDROID_CLIENT_TYPE, "java.lang.Void"));
        }
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: dc.h1
    ...
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: dc.g1
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
