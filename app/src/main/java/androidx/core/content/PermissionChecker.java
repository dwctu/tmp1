...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i, int i2, @Nullable String str2) {
        ...
        return (Process.myUid() == i2 && ObjectsCompat.equals(context.getPackageName(), str2) ? AppOpsManagerCompat.checkOrNoteProxyOp(context, i2, strPermissionToOp, str2) : AppOpsManagerCompat.noteProxyOpNoThrow(context, strPermissionToOp, str2)) == 0 ? 0 : -2;
    }
