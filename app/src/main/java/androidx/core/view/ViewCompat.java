...
public class ViewCompat {
    ...
    private static final OnReceiveContentViewBehavior NO_OP_ON_RECEIVE_CONTENT_VIEW_BEHAVIOR = new OnReceiveContentViewBehavior() { // from class: dc.w2
    ...
    public static class Api28Impl {
        ...
        public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            ...
            View.OnUnhandledKeyEventListener onUnhandledKeyEventListener = new View.OnUnhandledKeyEventListener() { // from class: dc.c3
    ...
    public static int getMinimumHeight(@NonNull View view) throws NoSuchFieldException {
        if (Build.VERSION.SDK_INT >= 16) {
    ...
    public static int getMinimumWidth(@NonNull View view) throws NoSuchFieldException {
        if (Build.VERSION.SDK_INT >= 16) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, to = LinkedHashMultimap.VALUE_SET_LOAD_FACTOR) float f) {
        view.setAlpha(f);
    }
