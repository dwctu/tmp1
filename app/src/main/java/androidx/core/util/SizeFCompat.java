...
public final class SizeFCompat {
    ...
    public SizeFCompat(float f, float f2) {
        this.mWidth = Preconditions.checkArgumentFinite(f, VideoCaptureFormat.keyWidth);
        this.mHeight = Preconditions.checkArgumentFinite(f2, VideoCaptureFormat.keyHeight);
    }
