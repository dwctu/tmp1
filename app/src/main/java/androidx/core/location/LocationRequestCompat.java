...
public final class LocationRequestCompat {
    ...
    public String toString() {
        ...
        if (this.mMinUpdateDistanceMeters > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setMinUpdateDistanceMeters(@FloatRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, to = 3.4028234663852886E38d) float f) {
            this.mMinUpdateDistanceMeters = f;
