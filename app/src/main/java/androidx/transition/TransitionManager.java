...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo63clone = transition.mo63clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo63clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo63clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo63clone);
    }
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo63clone = transition.mo63clone();
        sceneChangeSetup(viewGroup, transitionMo63clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo63clone);
    }
