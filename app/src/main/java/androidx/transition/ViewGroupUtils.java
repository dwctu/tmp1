...
public class ViewGroupUtils {
    ...
    public static void suppressLayout(@NonNull ViewGroup viewGroup, boolean z) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
