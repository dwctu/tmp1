...
public final class NavInflater {
    ...
    @NotNull
    public final NavGraph inflate(@NavigationRes int graphResId) throws Resources.NotFoundException {
        int next;
