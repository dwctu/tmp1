...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    @JvmOverloads
    @NotNull
    public static final NavHostFragment create(@NavigationRes int i, @Nullable Bundle bundle) {
    ...
    */
    public void onCreate(@org.jetbrains.annotations.Nullable android.os.Bundle r7) throws android.content.res.Resources.NotFoundException {
        /*
            r6 = this;
