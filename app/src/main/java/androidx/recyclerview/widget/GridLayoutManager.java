    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i12 = 0; i12 < i7; i12++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i10) {
                ...
                int spaceForSpanRange = getSpaceForSpanRange(layoutParams.mSpanIndex, layoutParams.mSpanSize);
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i14, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
                    ...
                    childMeasureSpec = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i13, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
