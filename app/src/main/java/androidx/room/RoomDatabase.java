...
public abstract class RoomDatabase {
    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        public T build() {
            ...
            SupportSQLiteOpenHelper.Factory queryInterceptorOpenHelperFactory = queryCallback != null ? new QueryInterceptorOpenHelperFactory(sQLiteCopyOpenHelperFactory, this.mQueryCallbackExecutor, queryCallback) : sQLiteCopyOpenHelperFactory;
    ...
    public void beginTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: dc.d6
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return this.a.b((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    public void endTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: dc.e6
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return this.a.d((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
