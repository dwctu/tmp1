...
public class RoomOpenHelper extends SupportSQLiteOpenHelper.Callback {
    ...
    private void checkIdentity(SupportSQLiteDatabase supportSQLiteDatabase) throws SQLException {
        ...
        try {
            ...
            throw new IllegalStateException("Room cannot verify the data integrity. Looks like you've changed schema but forgot to update the version number. You can simply fix this by increasing the version number. Expected identity hash: " + string + ", found: " + this.mIdentityHash);
        } catch (Throwable th) {
            cursorQuery.close();
            throw th;
        }
