...
public final class QueryInterceptorOpenHelperFactory implements SupportSQLiteOpenHelper.Factory {
    ...
    public SupportSQLiteOpenHelper create(@NotNull SupportSQLiteOpenHelper.Configuration configuration) {
        ...
        SupportSQLiteOpenHelper supportSQLiteOpenHelperCreate = this.delegate.create(configuration);
        Intrinsics.checkNotNullExpressionValue(supportSQLiteOpenHelperCreate, "delegate.create(configuration)");
        return new QueryInterceptorOpenHelper(supportSQLiteOpenHelperCreate, this.queryCallbackExecutor, this.queryCallback);
    }
}
