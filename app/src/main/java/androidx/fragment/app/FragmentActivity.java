...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: dc.n3
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return this.a.j4();
            }
        });
        addOnConfigurationChangedListener(new Consumer() { // from class: dc.l3
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.a.l4((Configuration) obj);
            }
        });
        addOnNewIntentListener(new Consumer() { // from class: dc.k3
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.a.n4((Intent) obj);
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: dc.m3
    ...
    public /* synthetic */ void l4(Configuration configuration) {
