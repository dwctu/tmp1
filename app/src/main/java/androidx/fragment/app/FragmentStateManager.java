...
public class FragmentStateManager {
    ...
    public void destroy() {
        ...
        if (str3 != null) {
            fragment4.mTarget = this.mFragmentStore.findActiveFragment(str3);
        }
            ...
            while (true) {
                ...
                if (iComputeExpectedState == i) {
                    if (!z && i == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
                            String str2 = "Cleaning up state of never attached fragment: " + this.mFragment;
                        }
                        this.mFragmentStore.getNonConfig().clearNonConfigState(this.mFragment);
                        this.mFragmentStore.makeInactive(this);
                        if (FragmentManager.isLoggingEnabled(3)) {
                            String str3 = "initState called for fragment: " + this.mFragment;
                        }
                        this.mFragment.initState();
                    }
                    Fragment fragment2 = this.mFragment;
                ...
                if (iComputeExpectedState <= i) {
                    switch (i - 1) {
                        ...
                        case 3:
                            if (FragmentManager.isLoggingEnabled(3)) {
                                String str4 = "movefrom ACTIVITY_CREATED: " + this.mFragment;
                            }
                            Fragment fragment5 = this.mFragment;
    ...
    public void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                sb.append(" ");
                sb.append(zRequestFocus ? "succeeded" : StreamManagement.Failed.ELEMENT);
    ...
    public void saveViewState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            String str = "Saving view state for fragment " + this.mFragment + " with view " + this.mFragment.mView;
        }
    ...
    public FragmentStateManager(@NonNull FragmentLifecycleCallbacksDispatcher fragmentLifecycleCallbacksDispatcher, @NonNull FragmentStore fragmentStore, @NonNull ClassLoader classLoader, @NonNull FragmentFactory fragmentFactory, @NonNull FragmentState fragmentState) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            String str = "Instantiated fragment " + fragmentInstantiate;
        }
    }
