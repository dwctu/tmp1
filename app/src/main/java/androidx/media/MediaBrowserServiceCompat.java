...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public class MediaBrowserServiceApi21 extends MediaBrowserService {
            ...
            public MediaBrowserService.BrowserRoot onGetRoot(String str, int i, Bundle bundle) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        public BrowserRoot onGetRoot(String str, int i, Bundle bundle) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            Bundle extras;
            int i2;
        ...
        public void setSessionTokenOnHandler(MediaSessionCompat.Token token) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
