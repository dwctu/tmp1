...
public class GifTextView extends TextView {
    ...
    private Drawable getGifOrDefaultDrawable(int i) throws Resources.NotFoundException {
        if (i == 0) {
            return null;
        }
    ...
    private void init(AttributeSet attributeSet, int i, int i2) throws Resources.NotFoundException {
        if (attributeSet != null) {
            Drawable gifOrDefaultDrawable = getGifOrDefaultDrawable(attributeSet.getAttributeResourceValue(GifViewUtils.ANDROID_NS, "drawableLeft", 0));
            Drawable gifOrDefaultDrawable2 = getGifOrDefaultDrawable(attributeSet.getAttributeResourceValue(GifViewUtils.ANDROID_NS, "drawableTop", 0));
            Drawable gifOrDefaultDrawable3 = getGifOrDefaultDrawable(attributeSet.getAttributeResourceValue(GifViewUtils.ANDROID_NS, "drawableRight", 0));
            Drawable gifOrDefaultDrawable4 = getGifOrDefaultDrawable(attributeSet.getAttributeResourceValue(GifViewUtils.ANDROID_NS, "drawableBottom", 0));
            Drawable gifOrDefaultDrawable5 = getGifOrDefaultDrawable(attributeSet.getAttributeResourceValue(GifViewUtils.ANDROID_NS, "drawableStart", 0));
            Drawable gifOrDefaultDrawable6 = getGifOrDefaultDrawable(attributeSet.getAttributeResourceValue(GifViewUtils.ANDROID_NS, "drawableEnd", 0));
            ...
            setBackground(getGifOrDefaultDrawable(attributeSet.getAttributeResourceValue(GifViewUtils.ANDROID_NS, "background", 0)));
    ...
    public GifTextView(Context context, AttributeSet attributeSet, int i) throws Resources.NotFoundException {
        super(context, attributeSet, i);
        init(attributeSet, i, 0);
    }

    @RequiresApi(21)
    public GifTextView(Context context, AttributeSet attributeSet, int i, int i2) throws Resources.NotFoundException {
