...
public class RendererCommon {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$io$agora$base$internal$video$RendererCommon$ScalingType;
    ...
    public interface GlDrawer {
        ...
        void drawYuv(int[] iArr, float[] fArr, int i, int i2, int i3, int i4, int i5, int i6, VideoFrame.ColorSpace colorSpace);
    ...
    private static float convertScalingTypeToVisibleFraction(ScalingType scalingType) {
        int i = AnonymousClass1.$SwitchMap$io$agora$base$internal$video$RendererCommon$ScalingType[scalingType.ordinal()];
        if (i == 1) {
            return 1.0f;
        }
        if (i == 2) {
