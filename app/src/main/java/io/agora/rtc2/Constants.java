...
public class Constants {
    ...
    public static final int RHYTHM_PLAYER_ERROR_CAN_NOT_OPEN = 801;
    public static final int RHYTHM_PLAYER_ERROR_CAN_NOT_PLAY = 802;
    public static final int RHYTHM_PLAYER_ERROR_FAILED = 1;
    public static final int RHYTHM_PLAYER_ERROR_FILE_OVER_DURATION_LIMIT = 803;
    public static final int RHYTHM_PLAYER_ERROR_OK = 0;
    ...
    public static final int RTMP_STREAM_PUBLISH_ERROR_INVALID_PRIVILEGE = 16;
