...
public abstract class Completable implements CompletableSource {
    ...
    @SchedulerSupport("none")
    public final void blockingAwait() throws InterruptedException {
    ...
    public final Completable doAfterTerminate(Action action) {
        ...
        return doOnLifecycle(consumerEmptyConsumer, consumerEmptyConsumer2, action2, action2, action, action2);
    }
