...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public final Maybe<T> doAfterTerminate(Action action) {
        ...
        return RxJavaPlugins.onAssembly(new MaybePeek(this, consumerEmptyConsumer, consumerEmptyConsumer2, consumerEmptyConsumer3, action2, (Action) ObjectHelper.requireNonNull(action, "onAfterTerminate is null"), action2));
    }
    ...
    public final Maybe<T> doOnComplete(Action action) {
        ...
        return RxJavaPlugins.onAssembly(new MaybePeek(this, consumerEmptyConsumer, consumerEmptyConsumer2, consumerEmptyConsumer3, action2, action3, action3));
    }
    ...
    public final Maybe<T> doOnDispose(Action action) {
        ...
        Consumer consumerEmptyConsumer3 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, consumerEmptyConsumer, consumerEmptyConsumer2, consumerEmptyConsumer3, action2, action2, (Action) ObjectHelper.requireNonNull(action, "onDispose is null")));
    }
