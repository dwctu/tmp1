...
public final class JobCancellationException extends CancellationException implements oz3<JobCancellationException> {

    @JvmField
    @NotNull
    public final h14 job;

    public JobCancellationException(@NotNull String str, @Nullable Throwable th, @NotNull h14 h14Var) {
        super(str);
        this.job = h14Var;
        if (th != null) {
            initCause(th);
