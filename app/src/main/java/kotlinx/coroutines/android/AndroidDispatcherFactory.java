...
public final class AndroidDispatcherFactory implements j64 {
    @Override // dc.j64
    @NotNull
    public s14 createDispatcher(@NotNull List<? extends j64> list) {
        Looper mainLooper = Looper.getMainLooper();
        if (mainLooper == null) {
            throw new IllegalStateException("The main looper is not available");
        }
        return new l24(n24.a(mainLooper, true), null, 2, 0 == true ? 1 : 0);
    }
