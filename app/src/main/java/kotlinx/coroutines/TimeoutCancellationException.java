...
public final class TimeoutCancellationException extends CancellationException implements oz3<TimeoutCancellationException> {

    @JvmField
    @Nullable
    public final h14 coroutine;

    public TimeoutCancellationException(@NotNull String str, @Nullable h14 h14Var) {
        super(str);
        this.coroutine = h14Var;
    }
